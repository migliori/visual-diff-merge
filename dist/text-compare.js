...
/* harmony export */   TextCompareManager: () => (/* binding */ TextCompareManager),
...
var TextCompareManager = /*#__PURE__*/function () {
  ...
  function TextCompareManager() {
    ...
    _classCallCheck(this, TextCompareManager);
    ...
    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.initialize(window.diffConfig.debug, '[DiffViewer]', window.diffConfig.logLevel);
    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Constructor called', null, 2);
   ...
   */
  return _createClass(TextCompareManager, [{
    key: "initialize",
    value: (function () {
      var _initialize = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Starting initialization', null, 2);
      ...
      var _init = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Initializing', null, 2);
              if (this.form) {
                this.form.addEventListener('submit', function (event) {
                  return _this.handleFormSubmit(event);
                });
              } else {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('TextCompareManager: Form element not found', null, 1);
              }
            ...
            case 4:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("TextCompareManager: Initialized with language: ".concat(this.translationManager.getLanguage()), null, 2);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Initialization complete', null, 2);
            case 6:
            case "end":
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Loading language settings - START', null, 2);
              _context3.prev = 1;
              _context3.next = 4;
              return this.endpointDiscovery.getEndpoint('endpointsConfig');
            case 4:
              configEndpoint = _context3.sent;
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Config endpoint', configEndpoint, 3);

              // Fetch configuration including languages
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Fetching from endpoint', configEndpoint, 3);
              _context3.next = 9;
            ...
            case 15:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Received config data', configData, 3);

              // If we have language settings, apply them to translation manager
              if (configData.lang && configData.translations) {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("TextCompareManager: Found language settings (".concat(configData.lang, ")"), null, 2);
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Loading language settings - END', null, 2);
              return _context3.abrupt("return", true);
            case 22:
              _context3.prev = 22;
              _context3.t0 = _context3["catch"](1);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: Error loading language settings', _context3.t0, 1);
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Handling text comparison submission', null, 2);
            ...
            case 16:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Skipping diff viewer for identical content', null, 2);
            ...
            case 27:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: Error processing diff', _context4.t0, 1);
    ...
    value: function resetConfig() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Resetting configuration', null, 3);
    ...
    value: function cleanupPreviousInstance() {
      ...
      if (window.diffViewer) {
        try {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Cleaning up previous DiffViewer instance', null, 2);
          window.diffViewer.destroy();
          window.diffViewer = null;
        } catch (e) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('TextCompareManager: Error destroying previous diffViewer', e, 1);
        }
      }
      if (window.vdmBrowserUIManager) {
        try {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Cleaning up previous BrowserUIManager instance', null, 2);
          window.vdmBrowserUIManager.destroy();
          window.vdmBrowserUIManager = null;
        } catch (e) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('TextCompareManager: Error destroying previous BrowserUIManager', e, 1);
        }
      }
    }
    ...
    value: function getTextData() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Getting text data from inputs', null, 3);
    ...
    value: function configureDiff(textData) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Configuring diff parameters', textData, 3);
      var configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__.DiffConfigManager.getInstance();
      ...
      var _processDiff = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Processing diff with API', null, 2);
              _context5.prev = 1;
            ...
            case 11:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Using discovered endpoint', apiEndpoint, 2);
              _context5.next = 18;
              break;
            case 15:
              _context5.prev = 15;
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('TextCompareManager: Endpoint discovery failed', _context5.t0, 1);
            case 18:
              ...
              if (!apiEndpoint) {
                ...
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('TextCompareManager: Using fallback endpoint', apiEndpoint, 1);
              }
              ...
              if (result.config) {
                ...
                for (_i = 0, _importantProps = importantProps; _i < _importantProps.length; _i++) {
                  ...
                  if (result.config[prop] !== undefined && (result[prop] === undefined || prop === 'diffData' && (!result[prop].chunks || result[prop].chunks.length === 0))) {
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("TextCompareManager: Moving ".concat(prop, " from config to root level"), null, 2);
            ...
            case 40:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: API processing failed', _context5.t1, 1);
              throw _context5.t1;
            case 44:
            case "end":
      ...
      var _initializeDiffViewer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Initializing diff viewer', null, 2);
              _context6.prev = 1;
              if (!(typeof window.enableDiffViewer === 'function')) {
                _context6.next = 10;
                break;
              }
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Using enableDiffViewer function', null, 2);
            ...
            case 10:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: enableDiffViewer function not available', null, 1);
            ...
            case 14:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: Error initializing diff viewer', _context6.t0, 1);
              throw _context6.t0;
            case 18:
            case "end":
    ...
    value: function handleIdenticalContent(message) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Texts contain identical content', message, 2);
      ...
      if (!containerWrapper) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: Container wrapper not found for alert display');
      ...
      if (this.containerWrapper) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Hidden diff container for identical content', null, 2);
      }
    ...
    value: function handleError(error) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: Error processing diff', error, 1);
      ...
      var containerWrapper = document.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].CONTAINER.WRAPPER);
      if (!containerWrapper) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('TextCompareManager: Container wrapper not found for error display');
        // If no container wrapper, use the default alert mechanism as a fallback
      ...
      if (this.containerWrapper) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TextCompareManager: Hidden diff container due to error', null, 2);
      }
...
// Export the class
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TextCompareManager);
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_browser_TextCompareManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/browser/TextCompareManager */ "./src/components/browser/TextCompareManager.js");
...
window.TextCompareManager = _components_browser_TextCompareManager__WEBPACK_IMPORTED_MODULE_0__.TextCompareManager;
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        manager = new _components_browser_TextCompareManager__WEBPACK_IMPORTED_MODULE_0__.TextCompareManager(); // Initialize the manager (async operation)
        _context.next = 3;
