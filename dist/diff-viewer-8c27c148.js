...
/* harmony import */ var _utils_ConfigUtils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(219);
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        debug = ((_window$diffConfig = window.diffConfig) === null || _window$diffConfig === void 0 ? void 0 : _window$diffConfig.debug) || false;
        logLevel = ((_window$diffConfig2 = window.diffConfig) === null || _window$diffConfig2 === void 0 ? void 0 : _window$diffConfig2.logLevel) || 1;
      ...
      case 42:
        ...
        validationResult = _utils_ConfigUtils__WEBPACK_IMPORTED_MODULE_12__/* .ConfigUtils */ .c.validateConfig(window.diffConfig);
      ...
      case 50:
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_4__/* .Debug */ .y.log('CONFIGURATION SUMMARY', _utils_ConfigUtils__WEBPACK_IMPORTED_MODULE_12__/* .ConfigUtils */ .c.getConfigSummary(window.diffConfig), 1);
        ...
        themePrefs = _utils_ConfigUtils__WEBPACK_IMPORTED_MODULE_12__/* .ConfigUtils */ .c.getThemePreferences(window.diffConfig); // 1. Configure ResourceLoader WITHOUT theme loading
        ...
        resourceLoader.configure({
          ...
          language: _utils_ConfigUtils__WEBPACK_IMPORTED_MODULE_12__/* .ConfigUtils */ .c.getFileExtension(window.diffConfig.filepath, 'php')
        });
