...
/* harmony export */   FileBrowserManager: () => (/* binding */ FileBrowserManager)
/* harmony export */ });
...
/* harmony import */ var _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/TranslationManager */ "./src/utils/TranslationManager.js");
...
var FileBrowserManager = /*#__PURE__*/function () {
  ...
  function FileBrowserManager() {
    ...
    _classCallCheck(this, FileBrowserManager);
    ...
    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Constructor - Element detection', {
    ...
    this.loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_3__.LoaderManager.getInstance();

    // Initialize translation manager
    this.translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_2__.TranslationManager.getInstance();
   ...
   * @param {Object} options - Configuration options
   */
  return _createClass(FileBrowserManager, [{
    key: "initAsync",
    value: (function () {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_5__.DiffConfigManager.getInstance();
              _context.next = 5;
              return configManager.initialize(_objectSpread({
            ...
            case 8:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: Error during async initialization', _context.t0, 1);
    ...
    value: function init() {
      var _this = this;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Initializing', null, 2);

      // Check if we have the new single select system
      if (this.compareFileSelect) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Using new single file select system', null, 2);
        // No need for sync in single select mode
      } else if (this.oldFileSelect && this.newFileSelect) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Using legacy dual file select system', null, 2);
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: No valid file select elements found', null, 1);
      }
      ...
      if (form) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: Form element not found', null, 1);
      }

      // Initial sync
      this.syncFileSelections();
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Initialization complete', null, 2);
    }
    ...
    value: (function () {
      var _handleComparison = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(event) {
        var alertManager, containerWrapper, loaderId, fileData, contents, result, configManager, existingServerSaveEnabled, uiManagerSuccess, viewerElement;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              event.preventDefault();
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Handling comparison', null, 2);

              // Get the AlertManager instance to clear any existing alerts
              alertManager = _utils_AlertManager__WEBPACK_IMPORTED_MODULE_4__["default"].getInstance();
              alertManager.hideAlert();

              // Get the container wrapper element
              containerWrapper = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].CONTAINER.WRAPPER.replace('#', '')); // Clear any existing content immediately before loading new content
              this.clearUI();
            ...
            case 14:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: File contents are identical', null, 2);
            ...
            case 24:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Files contain identical content according to backend', null, 2);
              this.loaderManager.hideMainLoader(loaderId);
              this.handleIdenticalContent();
              return _context2.abrupt("return");
            case 30:
              // 5. Update diffConfig with result - but preserve runtime values
              configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_5__.DiffConfigManager.getInstance(); // Preserve existing serverSaveEnabled value that was set by FileBrowserManager
              existingServerSaveEnabled = configManager.get('serverSaveEnabled');
              ...
              if (existingServerSaveEnabled !== null && existingServerSaveEnabled !== undefined) {
                ...
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Restored serverSaveEnabled after setDiffConfig', existingServerSaveEnabled, 2);
              }
            ...
            case 37:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: Failed to initialize UI manager', null, 1);
              this.loaderManager.hideMainLoader(loaderId);
              return _context2.abrupt("return");
            case 42:
              _context2.next = 44;
            ...
            case 46:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: Error during comparison', _context2.t0, 1);
    ...
    value: function cleanupPreviousInstance() {
      ...
      if (window.diffViewer) {
        try {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Cleaning up previous DiffViewer instance', null, 2);
          window.diffViewer.destroy();
          window.diffViewer = null;
        } catch (e) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: Error destroying previous diffViewer', e, 1);
        }
      }
      if (window.vdmBrowserUIManager) {
        try {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Cleaning up previous BrowserUIManager instance', null, 2);
          window.vdmBrowserUIManager.destroy();
          window.vdmBrowserUIManager = null;
        } catch (e) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: Error destroying previous BrowserUIManager', e, 1);
        }
      }
    }
    ...
    value: (function () {
      var _initializeUIManager = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var initResult;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Initializing UI manager', null, 2);
              ...
              _context3.next = 6;
              return window.vdmBrowserUIManager.initialize(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].CONTAINER.WRAPPER);
            case 6:
            ...
            case 11:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: BrowserUIManager initialize returned false, falling back to manual UI creation', null, 1);
            ...
            case 15:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: BrowserUIManager initialize failed', _context3.t0, 1);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: Falling back to manual UI creation due to BrowserUIManager error', null, 1);
              return _context3.abrupt("return", this.createBasicUIElements());
            case 20:
              _context3.next = 24;
              break;
            case 22:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: BrowserUIManager not available, UI elements must be created manually', null, 1);
    ...
    value: (function () {
      var _initializeDiffViewer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
        var _window$diffConfig$ne, _window$diffConfig$ne2, _window$diffConfig$ne3, _window$diffConfig$ol, _window$diffConfig$ol2, configManager, currentFileRefId, hasFileRefs, viewerContainer, initResult, themeSwitcherId, themeSwitcherExists;
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Initializing diff viewer', null, 2);
              ...
              configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_5__.DiffConfigManager.getInstance(); // Update container with correct selector ID
              configManager.set('container', _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].DIFF.VIEWER.replace('#', ''));
              ...
              if (!window.diffConfig.fileRefId && (_window$diffConfig$ne = window.diffConfig["new"]) !== null && _window$diffConfig$ne !== void 0 && _window$diffConfig$ne.ref_id) {
                ...
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Setting top-level fileRefId from new.ref_id', window.diffConfig["new"].ref_id, 1);
              }
              ...
              if (!window.diffConfig.newFileName && (_window$diffConfig$ne2 = window.diffConfig["new"]) !== null && _window$diffConfig$ne2 !== void 0 && _window$diffConfig$ne2.filename) {
                ...
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Setting top-level newFileName from new.filename', window.diffConfig["new"].filename, 1);
              }

              // Always explicitly set serverSaveEnabled if we have file references
              // Use the value that was just set or the current value
              currentFileRefId = window.diffConfig.fileRefId || ((_window$diffConfig$ne3 = window.diffConfig["new"]) === null || _window$diffConfig$ne3 === void 0 ? void 0 : _window$diffConfig$ne3.ref_id) || '';
              hasFileRefs = !!(currentFileRefId || window.diffConfig.oldFileRefId || (_window$diffConfig$ol = window.diffConfig.old) !== null && _window$diffConfig$ol !== void 0 && _window$diffConfig$ol.ref_id);
              configManager.set('serverSaveEnabled', hasFileRefs);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Setting serverSaveEnabled', {
                hasFileRefs: hasFileRefs,
                currentFileRefId: currentFileRefId,
                oldFileRefId: window.diffConfig.oldFileRefId || ((_window$diffConfig$ol2 = window.diffConfig.old) === null || _window$diffConfig$ol2 === void 0 ? void 0 : _window$diffConfig$ol2.ref_id)
              }, 1);

              // DEBUG log the final diffConfig properties before initialization
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Final diffConfig settings before initialization', {
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: No valid diff data found for initialization', {
            ...
            case 19:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: DiffViewer initialization result', initResult, 2);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: BrowserUIManager available', !!window.vdmBrowserUIManager, 2);
              ...
              if (initResult) {
                ...
                if (window.vdmBrowserUIManager) {
                  ...
                  themeSwitcherId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].THEME.SWITCHER.name();
                  themeSwitcherExists = !!document.getElementById(themeSwitcherId);
                  _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Theme switcher exists in DOM', themeSwitcherExists, 2);
                  if (!themeSwitcherExists) {
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Theme switcher not found, regenerating', null, 2);
                  ...
                  if (typeof window.vdmBrowserUIManager.showThemeElements === 'function') {
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Calling showThemeElements after DiffViewer initialization', null, 2);
                    window.vdmBrowserUIManager.showThemeElements();
                  }
                } else {
                  _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: BrowserUIManager not available, cannot show theme elements', null, 1);
                }
              } else {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: DiffViewer initialization failed, not showing theme elements', null, 1);
              }
            ...
            case 26:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: DiffViewer not available, falling back to enableDiffViewer', null, 2);
              return _context4.abrupt("return", window.enableDiffViewer());
            case 31:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: DiffViewer not available', null, 1);
    ...
    value: function getSelectedFilesData() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Getting selected files data', null, 3);

      // Check if we're using the new single select system
      if (this.compareFileSelect) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Using single select system', null, 3);
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Single select data', {
          oldRefId: oldRefId,
          newRefId: newRefId,
          oldPath: oldPath,
          newPath: newPath
      ...
      if (this.oldFileSelect && this.newFileSelect) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Using legacy dual select system', null, 3);
        return {
          old: {
    ...
    value: (function () {
      var _fetchFileContents = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(fileData) {
        var fetchFile, oldContent, newContent;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Fetching file contents', fileData, 3);

              // Use the API endpoint to safely retrieve file content
              fetchFile = /*#__PURE__*/function () {
                var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5(filePath, refId) {
                  ...
                  return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                    while (1) switch (_context5.prev = _context5.next) {
                      case 0:
                        ...
                        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Using reference ID for file', {
                          filePath: filePath,
                          refId: refId
                        }, 3);
                        ...
                        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: API URL', {
                          apiUrl: apiUrl,
                      ...
                      case 17:
                        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Using direct path for file', {
                          filePath: filePath
                        }, 3);
            ...
            case 8:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Files contain identical content', null, 2);
            ...
            case 15:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: Failed to load one or both files', _context6.t0, 1);
              throw _context6.t0;
            case 19:
            case "end":
    ...
    value: function configureDiffData(fileData, contents) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Configuring diff data', fileData, 3);

      // DEBUG: Log file reference data before configuration
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: File reference data before configuration', {
        old: {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Configured diffConfig file references', {
        fileRefId: window.diffConfig.fileRefId,
        oldFileRefId: window.diffConfig.oldFileRefId,
        newFileName: window.diffConfig.newFileName,
        oldFileName: window.diffConfig.oldFileName,
    ...
    key: "processDiff",
    value: (function () {
      var _processDiff = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Processing diff with API', null, 2);
            ...
            case 5:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Endpoint discovery found endpoint', diffProcessorEndpoint, 2);
              _context7.next = 13;
              break;
            case 9:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Using fallback endpoint', diffProcessorEndpoint, 2);
            case 13:
              _context7.next = 21;
              break;
            case 15:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: Error discovering endpoints', _context7.t0, 1);
              // Fall back to config or default - use DiffConfigManager for latest server config
              _configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_5__.DiffConfigManager.getInstance();
            ...
            case 23:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: API request failed', {
            ...
            case 29:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: API returned error', result.error, 1);
              throw new Error(result.error);
            case 33:
              // Initialize TranslationManager with server-provided data
              translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_2__.TranslationManager.getInstance();
              if (result.config && result.config.translations) {
                lang = result.config.lang || 'en';
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("FileBrowserManager: Initializing TranslationManager with \"".concat(lang, "\" language from server response"), result.config.translations, 2);
              ...
              if (result.config && _typeof(result.config) === 'object') {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Moving all properties from config to root level', result.config, 2);
                ...
                Object.keys(result.config).forEach(function (key) {
                  ...
                  if (key === 'serverSaveEnabled') {
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Preserving existing serverSaveEnabled, not overwriting from server', {
                      existing: result.serverSaveEnabled,
                      fromServer: result.config[key]
                    }, 2);
                  ...
                  if (result[key] === undefined || key === 'diffData' && (!((_result$key = result[key]) !== null && _result$key !== void 0 && _result$key.chunks) || result[key].chunks.length === 0)) {
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("FileBrowserManager: Moving ".concat(key, " from config to root level"), result.config[key], 3);
    ...
    value: function updateDiffConfig(result) {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Updating diff config with API response', null, 3);
      // Make sure we have a valid result
      if (!result || _typeof(result) !== 'object') {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: Invalid result from API', result, 1);
      ...
      if ((_result$config = result.config) !== null && _result$config !== void 0 && _result$config.translations) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Server translations set in window.diffConfig', {
      ...
      if (result.config && result.config.demoEnabled !== undefined) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Demo mode flag set from server', this.diffConfig.demoEnabled, 2);
      }
      ...
      // Handle case where we have data but in an unexpected format
        ...
        if (result.config.diffData) {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: API returned success but no diffData was found in the response', result, 2);
        }
      }
      // Fallback when no recognizable diff data is found
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: Could not extract diff data from API response', result, 2);
      }

      // Additional validations
      if (!Array.isArray(this.diffConfig.diffData.old)) {
        this.diffConfig.diffData.old = [];
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: diffData.old is not an array, using empty array instead', null, 2);
      }
      if (!Array.isArray(this.diffConfig.diffData["new"])) {
        this.diffConfig.diffData["new"] = [];
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: diffData.new is not an array, using empty array instead', null, 2);
      }
      if (!Array.isArray(this.diffConfig.diffData.chunks)) {
        this.diffConfig.diffData.chunks = [];
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: diffData.chunks is not an array, using empty array instead', null, 2);
      }
      ...
      window.diffConfig = _objectSpread({}, this.diffConfig);
    ...
    value: function processDemoResponse(result) {
      ...
      if (result.demo && result.simulated) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Demo mode detected', null, 2);
        ...
        var translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_2__.TranslationManager.getInstance();
    ...
    value: function handleError(error, loadingElement, viewerElement) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: Error processing diff', error, 1);
    ...
    value: function clearUI() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Clearing UI', null, 2);

      // Get the container wrapper element
      var containerWrapper = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].CONTAINER.WRAPPER.replace('#', ''));
      if (containerWrapper) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Container wrapper found, current HTML length:', containerWrapper.innerHTML.length, 2);

        // Log all current children before preservation
        var currentChildren = Array.from(containerWrapper.children);
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Current children before preservation:', currentChildren.map(function (child) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("FileBrowserManager: Clearing container innerHTML, current content: \"".concat(containerWrapper.innerHTML.substring(0, 100), "...\""), null, 2);
        containerWrapper.innerHTML = '';

        // Restore only user content elements (theme selectors will be recreated as needed)
        if (elementsToPreserve.length > 0) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("FileBrowserManager: Restoring ".concat(elementsToPreserve.length, " preserved elements (user content only)"), null, 2);
          elementsToPreserve.forEach(function (element, index) {
            _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("FileBrowserManager: Restoring element ".concat(index + 1, ": ").concat(element.tagName, "#").concat(element.id || 'no-id', ".").concat(element.className || 'no-class'), null, 3);
            containerWrapper.appendChild(element);
          });
        } else {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: No elements to restore', null, 2);
        }

        // Log final state
        var finalChildren = Array.from(containerWrapper.children);
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Final children after restoration:', finalChildren.map(function (child) {
          return "".concat(child.tagName, "#").concat(child.id || 'no-id', ".").concat(child.className || 'no-class');
        }), 2);
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: UI cleared', null, 2);
    }
    ...
    value: function syncFileSelections() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Syncing file selections', null, 3);

      // Only sync if we're using the legacy dual select system
      if (this.compareFileSelect) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Skipping sync - using single select system', null, 3);
        return;
      }
      if (!this.oldFileSelect || !this.newFileSelect) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('FileBrowserManager: Cannot sync file selections - select elements not found', null, 2);
        return;
      }
    ...
    value: function handleIdenticalContent() {
      ...
      if (containerWrapper) {
        ...
        var diffContainer = containerWrapper.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].DIFF.CONTAINER);
        if (diffContainer) {
          diffContainer.style.display = 'none';
        }
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Hidden diff container for identical content', null, 2);
      }
    ...
    value: function createBasicUIElements() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Creating basic UI elements manually', null, 2);

      // Get the container wrapper element
      var containerWrapper = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].CONTAINER.WRAPPER.replace('#', ''));
      if (!containerWrapper) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('FileBrowserManager: Container wrapper not found', _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].CONTAINER.WRAPPER, 1);
        return false;
      }

      // Create the main diff viewer container
      var diffViewerId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].DIFF.VIEWER.replace('#', '');
      ...
      if (!diffViewer) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Created diff viewer element', {
          id: diffViewerId
        }, 2);
      }

      // Create the diff container inside the viewer
      var diffContainerId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].DIFF.CONTAINER.replace('#', '');
      ...
      if (!diffContainer) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Created diff container element', {
          id: diffContainerId
        }, 2);
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Basic UI elements created successfully', null, 2);
      return true;
    }
    ...
    value: function hideThemeSelector() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Hiding theme selector for identical content', null, 2);

      // Hide theme switcher container
      var themeSwitcher = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].THEME.SWITCHER.name());
      if (themeSwitcher) {
        themeSwitcher.style.display = 'none';
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Hidden theme switcher container', themeSwitcher.id, 2);
      }

      // Hide theme selector wrapper if it exists independently
      var themeSelectorWrapper = document.querySelector(".".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].THEME_SWITCHER.WRAPPER.name()));
      if (themeSelectorWrapper) {
        themeSelectorWrapper.style.display = 'none';
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Hidden theme selector wrapper', null, 2);
      }

      // Hide individual theme selector if it exists
      var themeSelector = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].THEME.SELECTOR.name());
      if (themeSelector) {
        themeSelector.style.display = 'none';
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('FileBrowserManager: Hidden theme selector', themeSelector.id, 2);
      }
    }
  }]);
}();
...
var BrowserUIManager = /*#__PURE__*/function () {
  ...
  return _createClass(BrowserUIManager, [{
    ...
    value: function generateThemeSwitcher() {
      ...
      if (themeSwitcher) {
        ...
        if (diffContainer || this.container.contains(themeSwitcher)) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Reusing existing theme switcher', themeSwitcherId, 2);
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Removing orphaned theme switcher', themeSwitcherId, 2);
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Creating new theme switcher', themeSwitcherId, 2);
    ...
    value: function generateThemeSelector() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Generating theme selector', null, 3);

      // Get the ID without the # prefix for createElement
      var themeSelectorId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].THEME.SELECTOR.name();
      var themeSwitcherId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].THEME.SWITCHER.name();
      ...
      if (existingSelector) {
        ...
        if (themeSwitcher && themeSwitcher.contains(selectorContainer)) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Reusing existing theme selector', themeSelectorId, 2);
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Removing orphaned theme selector', themeSelectorId, 2);
      ...
      if (!themeSwitcherContainer) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('BrowserUIManager: No theme switcher container found for theme selector', null, 2);
        return null;
      }

      // Create new theme selector container and element
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Creating new theme selector', themeSelectorId, 2);

      // Create the container using utility classes
      selectorContainer = document.createElement('div');
      selectorContainer.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].THEME_SELECTOR.WRAPPER.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].UTILITY.MARGIN_END_3.name());

      // Create select element
      var selectElement = document.createElement('select');
      selectElement.id = themeSelectorId;
      selectElement.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].UTILITY.FORM_SELECT.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].UTILITY.FORM_SELECT.name());
      ...
      this.elements.themeSelectorContainer = selectorContainer;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Theme selector created and added to DOM', null, 2);
      return {
        container: selectorContainer,
    ...
    value: function destroy() {
      ...
      var existingThemeSwitcher = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].THEME.SWITCHER.name());
      var existingThemeSelector = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].THEME.SELECTOR.name());
    ...
    value: function hideThemeElements() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Hiding theme elements for identical content', null, 2);
      if (this.elements.themeSwitcher) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Hidden theme switcher', this.elements.themeSwitcher.id, 2);
      }

      // Also hide any standalone theme selector
      var themeSelector = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].THEME.SELECTOR.name());
      if (themeSelector) {
        themeSelector.style.display = 'none';
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Hidden standalone theme selector', themeSelector.id, 2);
      }
    }
    ...
    value: function showThemeElements() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Showing theme elements for diff content', null, 2);
      if (this.elements.themeSwitcher) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Shown theme switcher', this.elements.themeSwitcher.id, 2);
      }
      ...
      if (themeSelector) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('BrowserUIManager: Shown standalone theme selector', themeSelector.id, 2);
      }
    }
  }]);
}();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BrowserUIManager: () => (/* reexport safe */ _components_viewer_BrowserUIManager__WEBPACK_IMPORTED_MODULE_1__.BrowserUIManager),
/* harmony export */   FileBrowserManager: () => (/* reexport safe */ _components_browser_FileBrowserManager__WEBPACK_IMPORTED_MODULE_0__.FileBrowserManager)
/* harmony export */ });
/* harmony import */ var _components_browser_FileBrowserManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/browser/FileBrowserManager */ "./src/components/browser/FileBrowserManager.js");
/* harmony import */ var _components_viewer_BrowserUIManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/viewer/BrowserUIManager */ "./src/components/viewer/BrowserUIManager.js");
/**
...
if (typeof window !== 'undefined') {
  window.FileBrowserManager = _components_browser_FileBrowserManager__WEBPACK_IMPORTED_MODULE_0__.FileBrowserManager;
  window.BrowserUIManager = _components_viewer_BrowserUIManager__WEBPACK_IMPORTED_MODULE_1__.BrowserUIManager;
}
})();
