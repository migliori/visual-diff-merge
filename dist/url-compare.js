    ...
    value: (function () {
      var _ensureServerConfigLoaded = DiffConfigManager_asyncToGenerator(/*#__PURE__*/DiffConfigManager_regeneratorRuntime().mark(function _callee() {
        ...
        return DiffConfigManager_regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              if (!DiffConfigManager_classPrivateFieldGet(_diffConfig, this).apiBaseUrl) {
                _context.next = 3;
                break;
              }
              Debug.log('DiffConfigManager: Server config already loaded with apiBaseUrl', DiffConfigManager_classPrivateFieldGet(_diffConfig, this).apiBaseUrl, 2);
            ...
            case 17:
              ...
              if (serverConfig && DiffConfigManager_typeof(serverConfig) === 'object') {
                ...
                DiffConfigManager_classPrivateFieldSet(_diffConfig, this, DiffConfigManager_objectSpread(DiffConfigManager_objectSpread({}, DiffConfigManager_classPrivateFieldGet(_diffConfig, this)), serverConfig));
                DiffConfigManager_assertClassBrand(_DiffConfigManager_brand, this, _updateGlobalDiffConfig).call(this);
              }
              _context.next = 22;
              break;
