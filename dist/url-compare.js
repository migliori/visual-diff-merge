...
/* harmony export */   UrlCompareManager: () => (/* binding */ UrlCompareManager),
...
/* harmony import */ var _utils_EndpointDiscovery__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/EndpointDiscovery */ "./src/utils/EndpointDiscovery.js");
...
/* harmony import */ var _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/LoaderManager */ "./src/utils/LoaderManager.js");
/* harmony import */ var _utils_AlertManager__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils/AlertManager */ "./src/utils/AlertManager.js");
/* harmony import */ var _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils/DiffConfigManager */ "./src/utils/DiffConfigManager.js");
...
var UrlCompareManager = /*#__PURE__*/function () {
  ...
  function UrlCompareManager() {
    ...
    _classCallCheck(this, UrlCompareManager);
    // DOM Elements
    ...
    var configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__.DiffConfigManager.getInstance();
    ...
    this.endpointDiscovery = _utils_EndpointDiscovery__WEBPACK_IMPORTED_MODULE_2__.EndpointDiscovery.getInstance();
   ...
   */
  return _createClass(UrlCompareManager, [{
    key: "initialize",
    value: (function () {
      var _initialize = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Starting initialization', null, 2);
      ...
      var _init = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Initializing', null, 2);
              if (this.form) {
                this.form.addEventListener('submit', function (event) {
                  return _this.handleFormSubmit(event);
                });
              } else {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('UrlCompareManager: Form element not found', null, 1);
              }
            ...
            case 4:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("UrlCompareManager: Initialized with language: ".concat(this.translationManager.getLanguage()), null, 2);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Initialization complete', null, 2);
            case 6:
            case "end":
    ...
    value: (function () {
      var _loadLanguageSettings = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var configEndpoint, response, configData, configManager;
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              // Replace console logs with Debug utility
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Loading language settings - START', null, 2);
              _context3.prev = 1;
              _context3.next = 4;
              return this.endpointDiscovery.getEndpoint('endpointsConfig');
            case 4:
              configEndpoint = _context3.sent;
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Config endpoint', configEndpoint, 3);

              // Fetch configuration including languages
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Fetching from endpoint', configEndpoint, 3);
              _context3.next = 9;
            ...
            case 9:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error("Failed to fetch config: ".concat(response.status, " ").concat(response.statusText));
            ...
            case 15:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Received config data', configData, 3);

              // If we have language settings, apply them to translation manager
              if (configData.lang && configData.translations) {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("UrlCompareManager: Found language settings (".concat(configData.lang, ")"), null, 2);

                // Log translation manager before initialization
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TranslationManager before initialization', {
                ...
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TranslationManager after initialization', {
                  lang: this.translationManager.getLanguage(),
                  initialized: this.translationManager.isInitialized()
                }, 3);

                // Update diffConfig with the new translations
                configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__.DiffConfigManager.getInstance();
                configManager.update({
                  lang: configData.lang,
                  translations: configData.translations
                });
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('Global diffConfig updated', {
                  lang: window.diffConfig.lang
                }, 2);
              } else {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('Language settings not found in config response', configData, 1);
              }
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Loading language settings - END', null, 2);
              return _context3.abrupt("return", true);
            case 22:
              _context3.prev = 22;
              _context3.t0 = _context3["catch"](1);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('UrlCompareManager: Error loading language settings', _context3.t0, 1);
    ...
    value: (function () {
      var _handleFormSubmit = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(event) {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Handling URL comparison submission', null, 2);

              // Get the LoaderManager instance
              loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_4__.LoaderManager.getInstance(); // Get the TranslationManager instance
              ...
              alertManager = _utils_AlertManager__WEBPACK_IMPORTED_MODULE_5__["default"].getInstance(); // Clear any existing alerts
            ...
            case 16:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Skipping diff viewer for identical content', null, 2);
            ...
            case 21:
              ...
              _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__.DiffConfigManager.getInstance().setDiffConfig(result);
            ...
            case 27:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('UrlCompareManager: Error processing diff', _context4.t0, 1);
    ...
    value: function resetConfig() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Resetting configuration', null, 3);
    ...
    value: function cleanupPreviousInstance() {
      ...
      if (window.diffViewer) {
        try {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Cleaning up previous DiffViewer instance', null, 2);
          window.diffViewer.destroy();
          window.diffViewer = null;
        } catch (e) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('UrlCompareManager: Error destroying previous diffViewer', e, 1);
        }
      }
      if (window.vdmBrowserUIManager) {
        try {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Cleaning up previous BrowserUIManager instance', null, 2);
          window.vdmBrowserUIManager.destroy();
          window.vdmBrowserUIManager = null;
        } catch (e) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('UrlCompareManager: Error destroying previous BrowserUIManager', e, 1);
        }
      }
    }
    ...
    value: function getUrlData() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Getting URL data from inputs', null, 3);
    ...
    value: function configureDiff(urlData) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Configuring diff parameters', urlData, 3);
      var configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__.DiffConfigManager.getInstance();
    ...
    key: "processDiff",
    value: (function () {
      var _processDiff = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Processing diff with API', null, 2);
              _context5.prev = 1;
              if (!(window.diffConfig.old.type === 'url' && window.diffConfig["new"].type === 'url')) {
                _context5.next = 40;
                break;
              }
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Fetching URL content before processing diff', null, 2);
              _context5.prev = 4;
            ...
            case 26:
              ...
              translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_3__.TranslationManager.getInstance(); // Use the generic identicalContentMessage translation key
            ...
            case 31:
              ...
              configManager = _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__.DiffConfigManager.getInstance();
              configManager.update({
                old: _objectSpread(_objectSpread({}, window.diffConfig.old), {}, {
                  content: oldUrlData.content
                }),
                "new": _objectSpread(_objectSpread({}, window.diffConfig["new"]), {}, {
                  content: newUrlData.content
                })
              });
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Successfully fetched URL content', null, 2);
              _context5.next = 40;
              break;
            case 36:
              _context5.prev = 36;
              _context5.t0 = _context5["catch"](4);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('UrlCompareManager: Error fetching URL content', _context5.t0, 1);
              throw _context5.t0;
            case 40:
            ...
            case 44:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Using discovered endpoint', apiEndpoint, 2);
              _context5.next = 51;
              break;
            case 48:
              _context5.prev = 48;
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('UrlCompareManager: Endpoint discovery failed', _context5.t1, 1);
            case 51:
              ...
              if (!apiEndpoint) {
                ...
                _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.warn('UrlCompareManager: Using fallback endpoint', apiEndpoint, 1);
              }
              ...
              if (csrfToken) {
                ...
                _utils_DiffConfigManager__WEBPACK_IMPORTED_MODULE_6__.DiffConfigManager.getInstance().set('csrfToken', csrfToken);
              }
              ...
              if (result.config) {
                ...
                for (_i = 0, _importantProps = importantProps; _i < _importantProps.length; _i++) {
                  ...
                  if (result.config[prop] !== undefined && (result[prop] === undefined || prop === 'diffData' && (!result[prop].chunks || result[prop].chunks.length === 0))) {
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("UrlCompareManager: Moving ".concat(prop, " from config to root level"), null, 2);
            ...
            case 73:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('UrlCompareManager: API processing failed', _context5.t2, 1);
              throw _context5.t2;
            case 77:
            case "end":
    ...
    value: (function () {
      var _initializeDiffViewer = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
        var result;
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) switch (_context6.prev = _context6.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Initializing diff viewer', null, 2);
              _context6.prev = 1;
              if (!(typeof window.enableDiffViewer === 'function')) {
                _context6.next = 10;
                break;
              }
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Using enableDiffViewer function', null, 2);
            ...
            case 10:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('UrlCompareManager: enableDiffViewer function not available', null, 1);
            ...
            case 14:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('UrlCompareManager: Error initializing diff viewer', _context6.t0, 1);
              throw _context6.t0;
            case 18:
            case "end":
    ...
    value: function handleIdenticalContent(message) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: URLs contain identical content', message, 2);
      ...
      var loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_4__.LoaderManager.getInstance();
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('Final message being displayed', localizedMessage, 2);

      // Hide any active loaders
      loaderManager.hideMainLoader();

      // Use AlertManager to create the alert
      var alertManager = _utils_AlertManager__WEBPACK_IMPORTED_MODULE_5__["default"].getInstance();
      ...
      var containerWrapper = document.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].CONTAINER.WRAPPER);
      if (containerWrapper) {
      ...
      if (this.containerWrapper) {
        ...
        var diffContainer = this.containerWrapper.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__["default"].DIFF.CONTAINER);
        if (diffContainer) {
          diffContainer.style.display = 'none';
        }
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Hidden diff container for identical content', null, 2);
      }
    ...
    value: function handleError(error) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.error('UrlCompareManager: Error processing diff', error, 1);
      ...
      // Hide any active loaders
      loaderManager.hideMainLoader();
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('TranslationManager', translationManager, 3);
      ...
      if (this.containerWrapper) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('UrlCompareManager: Hidden diff container due to error', null, 2);
      }
...
// Export the class
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UrlCompareManager);
...
/*!****************************!*\
  ...
  \****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_browser_UrlCompareManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/browser/UrlCompareManager */ "./src/components/browser/UrlCompareManager.js");
...
window.UrlCompareManager = _components_browser_UrlCompareManager__WEBPACK_IMPORTED_MODULE_0__.UrlCompareManager;
  ...
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        ...
        manager = new _components_browser_UrlCompareManager__WEBPACK_IMPORTED_MODULE_0__.UrlCompareManager(); // Initialize the manager (async operation)
        _context.next = 3;
