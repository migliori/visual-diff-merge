...
var MergeContentGenerator = /*#__PURE__*/function () {
  ...
  return _createClass(MergeContentGenerator, [{
    ...
    value: function generateMergedContent(selections) {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('leftChunkLines', leftChunkLines, 3);
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('rightChunkLines', rightChunkLines, 3);
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('selections', selections, 3);
