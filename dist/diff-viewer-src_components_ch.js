"use strict";
(this["webpackChunkdiff_files"] = this["webpackChunkdiff_files"] || []).push([["diff-viewer-src_components_ch"],{

/***/ "./src/components/chunks/ChunkRenderer.js":
/*!************************************************!*\
  !*** ./src/components/chunks/ChunkRenderer.js ***!
  \************************************************/
...
/* harmony import */ var _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/LoaderManager */ "./src/utils/LoaderManager.js");
...
var ChunkRenderer = /*#__PURE__*/function () {
  ...
  return _createClass(ChunkRenderer, [{
    ...
    value: function renderChunks() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ChunkRenderer: Beginning chunk rendering', null, 2);

      // Show loading indicator for large diffs (more than 100 chunks)
      var loaderId = null;
      if (this.chunkManager.chunks.length > 100) {
        var translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_4__.TranslationManager.getInstance();
        var loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_3__.LoaderManager.getInstance();
        var loadingMessage = translationManager.get('renderingDiff', 'Rendering diff...');
        loaderId = loaderManager.showLoader(loadingMessage, {
          fullscreen: true,
          zIndex: 1000
        });
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ChunkRenderer: Showing loader for large diff rendering', null, 2);
      }
      ...
      this.chunkManager.diffViewer.container.innerHTML = "\n            <div class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANES_CONTAINER.name(), "\">\n                <div class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE.name(), "\" id=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE_LEFT.name(), "\" data-side=\"left\">\n                    ").concat(leftHtml, "\n                </div>\n                <div class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE.name(), "\" id=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE_RIGHT.name(), "\" data-side=\"right\">\n                    ").concat(rightHtml, "\n                </div>\n            </div>\n        ");

      // Hide loader if shown
      if (loaderId) {
        var _loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_3__.LoaderManager.getInstance();
        _loaderManager.hideLoader(loaderId);

        // Log performance metrics
        var endTime = performance.now();
        var duration = endTime - startTime;
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkRenderer: Rendered ".concat(this.chunkManager.chunks.length, " chunks in ").concat(duration.toFixed(2), "ms"), null, 2);
      } else {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkRenderer: Rendered ".concat(this.chunkManager.chunks.length, " chunks successfully"), null, 2);
      }
    }
    ...
    value: function buildDiffPaneHtml(lines, side) {
      ...
      var html = "<div class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE_CONTENT.name(), " hljs\">"); // Add scrolling container
      html += "<div class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.TABLE_WRAPPER.name(), "\">");
      html += "<table class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].CODE.TABLE.name(), "\"><tbody>");
      var lineCounter = 0;
    ...
    value: function _renderDiffLine(line, side, lineNumber, chunksWithPlaceholders) {
      ...
      html += "<td class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].CODE.LINE_NUMBER.name(), "\">").concat(lineNumber, "</td>");
    ...
    value: function _renderPlaceholderLine(line, chunkId, chunkType, side, lineNumber) {
      ...
      if (chunkId !== '') {
        ...
        additionalClass += " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK.name());
        if (line.conflict || chunkType === 'replace' || chunkType === 'add' || chunkType === 'delete') {
          additionalClass += " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.UNRESOLVED.name());
        }
      }
      return "<td class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].CODE.LINE_CONTENT.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_CONTENT_EMPTY.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_PLACEHOLDER.name()).concat(additionalClass, "\"\n                   data-chunk-id=\"").concat(chunkId, "\"\n                   data-chunk-type=\"").concat(chunkType, "\"\n                   data-side=\"").concat(side, "\"\n                   data-placeholder-type=\"").concat(line.placeholderType || 'default', "\"\n                   data-line-id=\"").concat(side, "-").concat(lineNumber, "\"\n                   data-has-placeholder=\"true\">&nbsp;</td>");
    }
    ...
    value: function _renderContentLine(line, chunkId, chunkType, side, lineNumber, hasPlaceholder) {
      ...
      if (isEmpty) {
        additionalClass += " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].CODE.LINE_EMPTY.name());
        return "<td class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].CODE.LINE_CONTENT.name()).concat(additionalClass, "\"\n                       data-chunk-id=\"").concat(chunkId, "\"\n                       data-chunk-type=\"").concat(chunkType, "\"\n                       data-side=\"").concat(side, "\"\n                       data-line-id=\"").concat(side, "-").concat(lineNumber, "\"\n                       ").concat(hasPlaceholder ? 'data-has-placeholder="true"' : '', ">&nbsp;</td>");
      } else {
        // Add the line content with proper attributes for chunk handling
        var displayContent = _utils_StringUtils__WEBPACK_IMPORTED_MODULE_1__.StringUtils.escapeHtml ? _utils_StringUtils__WEBPACK_IMPORTED_MODULE_1__.StringUtils.escapeHtml(lineContent) : lineContent.replace(/</g, '&lt;').replace(/>/g, '&gt;');
    ...
    value: function _getChunkClass(chunkType, side) {
      if (chunkType === 'delete' && side === 'left') {
        return " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_DELETE.name());
      } else if (chunkType === 'add' && side === 'right') {
        return " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_ADD.name());
      } else if (chunkType === 'replace') {
        var cls = " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_ADD.name());
        if (side === 'left') {
          cls += " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_REPLACE_LEFT.name());
        } else {
          cls += " ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_REPLACE_RIGHT.name());
        }
        return cls;
      }
      return '';
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ChunkSelectionHandler: () => (/* binding */ ChunkSelectionHandler)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/Debug */ "./src/utils/Debug.js");
/* harmony import */ var _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/DOMUtils */ "./src/utils/DOMUtils.js");
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../constants/Selectors */ "./src/constants/Selectors.js");
/* harmony import */ var _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/ChunkUtils */ "./src/utils/ChunkUtils.js");
/* harmony import */ var _utils_IconRegistry__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/IconRegistry */ "./src/utils/IconRegistry.js");
...
/* harmony import */ var _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../utils/LoaderManager */ "./src/utils/LoaderManager.js");
/* harmony import */ var _ChunkVisualStateManager__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ChunkVisualStateManager */ "./src/components/chunks/ChunkVisualStateManager.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var ChunkSelectionHandler = /*#__PURE__*/function () {
  ...
  function ChunkSelectionHandler(chunkManager) {
    _classCallCheck(this, ChunkSelectionHandler);
    this.chunkManager = chunkManager;
    this.selections = {}; // Store selections separately
    this.visualStateManager = new _ChunkVisualStateManager__WEBPACK_IMPORTED_MODULE_7__.ChunkVisualStateManager(chunkManager);

    // Define selection state constants to replace hardcoded strings
    this.SELECTED = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name();
    this.UNSELECTED = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name();
   ...
   */
  return _createClass(ChunkSelectionHandler, [{
    ...
    value: function setupChunkSelection() {
      ...
      _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.setupEventHandlers('[data-chunk-id]:not([data-chunk-id=""])', 'click', this._boundClickHandler, {
        removeExisting: true,
        styles: {
          cursor: 'pointer'
        }
      ...
      _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.clearCache();
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ChunkSelectionHandler: Selection handlers initialized for all chunk elements', null, 2);
    }
    ...
    value: function _setupCheckAllButtons() {
      // Find panes
      var panes = this.chunkManager.diffViewer.container.querySelectorAll(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE);
      if (panes.length !== 2) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ChunkSelectionHandler: Could not find both diff panes for "Check All" buttons', null, 2);
        return;
      }
    ...
    value: function _createCheckAllButtonHeader(pane, side) {
      ...
      header.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE_HEADER.name();
      ...
      checkAllButton.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_EXTRA_SMALL.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SECONDARY.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHECK_ALL_BTN.name());
      ...
      var uncheckIcon = _utils_IconRegistry__WEBPACK_IMPORTED_MODULE_4__.IconRegistry.createIcon('checkbox-unchecked', {
        width: 14,
        height: 14,
    ...
    value: function _handleCheckAll(event) {
      ...
      var translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_5__.TranslationManager.getInstance();
      var loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_6__.LoaderManager.getInstance();
      if (!side) return;
      ...
      setTimeout(function () {
        ...
        if (iconState === 'checked') {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ChunkSelectionHandler: Unchecking all selections', null, 2);
    ...
    value: function _recordPerformanceMetrics(startTime) {
      ...
      var cacheStats = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getCacheStats();
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkSelectionHandler: Operation completed in ".concat(operationTime.toFixed(2), "ms"), {
    ...
    value: function _getOppositeButton(currentSide) {
      ...
      return this.chunkManager.diffViewer.container.querySelector(".".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHECK_ALL_BTN.name(), "[data-side=\"").concat(oppositeSide, "\"]"));
    }
    ...
    value: function _toggleButtonIconState(button, currentState) {
      ...
      if (currentState === 'unchecked') {
        ...
        iconWrapper.appendChild(_utils_IconRegistry__WEBPACK_IMPORTED_MODULE_4__.IconRegistry.createIcon('checkbox-checked', {
          width: 14,
          height: 14,
          classes: 'vdm-icon-checkbox'
        }));
        ...
        iconWrapper.appendChild(_utils_IconRegistry__WEBPACK_IMPORTED_MODULE_4__.IconRegistry.createIcon('checkbox-unchecked', {
          width: 14,
          height: 14,
          classes: 'vdm-icon-checkbox'
        }));
    ...
    value: function selectAllOnSide(side) {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkSelectionHandler: Selecting all chunks on ".concat(side, " side").concat(useBatch ? ' (batched)' : ''), null, 2);
      ...
      if (useBatch) {
        ...
        conflictChunks.forEach(function (chunk) {
          ...
          if (!chunksBySide.has(chunk.id)) {
            var elements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getChunkElements(chunk.id);
        ...
        requestAnimationFrame(function () {
          ...
          chunksBySide.forEach(function (elements) {
            elements.forEach(function (element) {
              element.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.RESOLVED.name());
              element.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.UNRESOLVED.name());
            });
          });
          ...
          if (loaderId) {
            var _loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_6__.LoaderManager.getInstance();
            _loaderManager.hideLoader(loaderId);
          }
    ...
    value: function _refreshIconStates(selectedSide, chunks) {
      ...
      chunks.forEach(function (chunk) {
        ...
        var selectedElements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getChunkElements(chunk.id, selectedSide);
        var oppositeElements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getChunkElements(chunk.id, oppositeSide);

        // Handle selected side
        if (selectedElements.length > 0) {
          // Sort by line number to get first element for icon marker
          var sortedElements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.sortElementsByLineNumber(selectedElements);
          ...
          if (firstElement) {
            ...
            if (lineId) {
              ...
              var iconMarker = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getIconMarker(lineId);
              if (iconMarker) {
                // Remove all state classes first
                iconMarker.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].ICONS.SELECT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].ICONS.SELECT_LEFT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].ICONS.SELECT_RIGHT.name());

                // Add selected state
                iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name());

                // Add the side-specific icon marker
                if (selectedSide === 'left') {
                  iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].ICONS.SELECT_LEFT.name());
                } else {
                  iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].ICONS.SELECT_RIGHT.name());
                }
              }
            }
          }
          ...
          selectedElements.forEach(function (element) {
            ...
            element.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name());

            // Add selected class
            element.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name());

            // Update the parent row too
            var row = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getParentRow(element);
            if (row) {
              row.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name());
              row.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name());
            }
          });
        }
        ...
        if (oppositeElements.length > 0) {
          ...
          var sortedOppositeElements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.sortElementsByLineNumber(oppositeElements);
          ...
          if (firstOppositeElement) {
            ...
            if (oppositeLineId) {
              var oppositeIconMarker = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getIconMarker(oppositeLineId);
              if (oppositeIconMarker) {
                ...
                var isPlaceholderType = firstOppositeElement.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_PLACEHOLDER.name());
                var wasPlaceholder = oppositeIconMarker.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].ICONS.MARKER_PLACEHOLDER.name());
                ...
                var selectedIsPlaceholderType = selectedElement === null || selectedElement === void 0 ? void 0 : selectedElement.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.LINE_PLACEHOLDER.name());
                ...
                if (hasPlaceholder || isPlaceholderType || wasPlaceholder || selectedHasPlaceholder || selectedIsPlaceholderType) {
                  // Set as placeholder
                  oppositeIconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].ICONS.MARKER_PLACEHOLDER.name());
                  _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkSelectionHandler: Set opposite marker ".concat(oppositeLineId, " as placeholder during batch refresh"), null, 3);
                } else {
                  // Normal unselected state
                  oppositeIconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name());
                }
              }
            }
          }
          ...
          oppositeElements.forEach(function (element) {
            ...
            element.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name());

            // Update the parent row too
            var row = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getParentRow(element);
            if (row) {
              row.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name());
              row.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_UNSELECTED.name());
            }
          });
        }
      });
    ...
    value: function _handleClick(event) {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkSelectionHandler: Click detected on side ".concat(side, " for chunk ").concat(chunkId), {
        element: element.outerHTML.substring(0, 100) + '...' // Log first 100 chars of HTML
      }, 3);
      if (chunkId && side) {
        // Check if the chunk is already selected on this side
        var isAlreadySelected = this.selections[chunkId] === side && element.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.CHUNK_SELECTED.name());
        if (isAlreadySelected) {
          var _this$chunkManager$di;
          // Unselect this chunk
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkSelectionHandler: Unselecting chunk ".concat(chunkId, " as it was already selected"), null, 3);
          ...
          var chunkElements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getChunkElements(chunkId);
          chunkElements.forEach(function (element) {
            element.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.RESOLVED.name());
            element.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.UNRESOLVED.name());
          });
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkSelectionHandler: Toggling chunk ".concat(chunkId), {
            selectedSide: side,
    ...
    value: function getSelections() {
      return _objectSpread({}, this.selections);
    }
    ...
    value: function clearAllSelections() {
      ...
      var startTime = performance.now();
      if (useBatch) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ChunkSelectionHandler: Clearing all selections using batch operations", null, 2);
        ...
        selectedChunkIds.forEach(function (chunkId) {
          ...
          var elements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getChunkElements(chunkId);
        ...
        requestAnimationFrame(function () {
          ...
          // Hide loader if it was shown
          if (loaderId) {
            var _loaderManager2 = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_6__.LoaderManager.getInstance();
        ...
        conflictChunks.forEach(function (chunk) {
          ...
          // Remove resolved status from all elements with this chunk ID
          var chunkElements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_3__.ChunkUtils.getChunkElements(chunk.id);
          chunkElements.forEach(function (element) {
            element.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.RESOLVED.name());
            element.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.UNRESOLVED.name());
          });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ChunkVisualStateManager: () => (/* binding */ ChunkVisualStateManager)
/* harmony export */ });
/* harmony import */ var _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/ChunkUtils */ "./src/utils/ChunkUtils.js");
...
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils/Debug */ "./src/utils/Debug.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function ownKeys(e, r) { var t = Object.keys(e); if (Object.getOwnPropertySymbols) { var o = Object.getOwnPropertySymbols(e); r && (o = o.filter(function (r) { return Object.getOwnPropertyDescriptor(e, r).enumerable; })), t.push.apply(t, o); } return t; }
function _objectSpread(e) { for (var r = 1; r < arguments.length; r++) { var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? ownKeys(Object(t), !0).forEach(function (r) { _defineProperty(e, r, t[r]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys(Object(t)).forEach(function (r) { Object.defineProperty(e, r, Object.getOwnPropertyDescriptor(t, r)); }); } return e; }
function _defineProperty(e, r, t) { return (r = _toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
...
var ChunkVisualStateManager = /*#__PURE__*/function () {
  ...
  function ChunkVisualStateManager(chunkManager) {
    ...
    _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log('ChunkVisualStateManager: Initialized', null, 3);
  }
  ...
  return _createClass(ChunkVisualStateManager, [{
    ...
    value: function initialize() {
      ...
      _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.preloadChunks();
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log('ChunkVisualStateManager: Initialized with preloaded chunks', null, 2);
    }
    ...
    value: function updateVisualState(chunkId, side, state) {
      var batch = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Updating visual state for chunk ".concat(chunkId, ", side ").concat(side, ", state ").concat(state), null, 3);

      // Get all elements for this chunk side
      var elements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.getChunkElements(chunkId, side);
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Found ".concat(elements.length, " elements for chunk ").concat(chunkId), null, 3);

      // Sort by line number (only needed for getting the first element)
      var sortedElements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.sortElementsByLineNumber(elements);
      ...
      if (batch) {
        ...
        if (sortedElements.length > 0) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Updating icon marker for first element of chunk ".concat(chunkId), null, 3);
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.warn("ChunkVisualStateManager: No elements found to update icon for chunk ".concat(chunkId), null, 3);
        }
    ...
    value: function _updateOppositeMarker(element, oppositeSide) {
      ...
      var oppositeMarker = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.getIconMarker(oppositeLineId);
      if (!oppositeMarker) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.warn("ChunkVisualStateManager: Could not find opposite marker for ".concat(oppositeLineId), null, 3);
        return;
      }
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Updating opposite marker ".concat(oppositeLineId), {
        currentClasses: Array.from(oppositeMarker.classList)
      }, 3);

      // Remove selection classes
      oppositeMarker.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_UNSELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT_LEFT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT_RIGHT.name());
      ...
      var wasPlaceholder = oppositeMarker.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.MARKER_PLACEHOLDER.name());
      if (wasPlaceholder) {
        // If it was a placeholder, keep it as a placeholder
        oppositeMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.MARKER_PLACEHOLDER.name());
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Preserved placeholder status for ".concat(oppositeLineId), null, 3);
      } else {
        // Otherwise mark it as unselected
        oppositeMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_UNSELECTED.name());
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Set opposite marker ".concat(oppositeLineId, " as unselected"), null, 3);
      }
    }
    ...
    value: function resetVisualState(chunkId) {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Resetting visual state for chunk ".concat(chunkId), null, 3);

      // Get all elements for this chunk (both sides)
      var elements = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.getChunkElements(chunkId);
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Found ".concat(elements.length, " elements for chunk ").concat(chunkId), null, 3);

      // Get icon markers associated with this chunk more efficiently
      var iconMarkers = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.getChunkIconMarkers(chunkId);
      if (batch) {
        // Add to batch queue
        this._pendingOperations.push({
          type: 'resetState',
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Reset ".concat(iconMarkers.length, " icon markers for chunk ").concat(chunkId), null, 3);
    ...
    value: function applyBatch() {
      ...
      requestAnimationFrame(function () {
        var startTime = performance.now();
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Applying batch of ".concat(batchSize, " operations"), null, 2);
        try {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Batch processing completed in ".concat(processingTime.toFixed(2), "ms"), {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.error("Error during batch processing: ".concat(error.message), error, 1);
        } finally {
          // Clear the queue
    ...
    value: function _applyStateToElements(elements, state) {
      ...
      var removeClasses = [_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_UNSELECTED.name()];
      var addClass = '';
      if (state === 'selected') {
        addClass = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_SELECTED.name();
      } else if (state === 'unselected') {
        addClass = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_UNSELECTED.name();
      } else {
      ...
      elements.forEach(function (element) {
        ...
        if (element.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.LINE_PLACEHOLDER.name())) {
          element.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.PLACEHOLDER.name());
        }

        // Collect parent row for batch update
        var row = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.getParentRow(element);
        if (row) {
          rows.add(row);
        }
      });
    ...
    value: function _applyResetToElements(elements, iconMarkers) {
      ...
      var removeClasses = [_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_UNSELECTED.name()];
      var iconRemoveClasses = [_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_SELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_UNSELECTED.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT_LEFT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT_RIGHT.name()];
      ...
      if (elements && elements.length > 0) {
        elements.forEach(function (el) {
          ...
          // Collect parent row for batch update
          var row = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.getParentRow(el);
          if (row) {
            rows.add(row);
          }
        });
      ...
      if (iconMarkers && iconMarkers.length > 0) {
        iconMarkers.forEach(function (marker) {
          if (marker) {
            ...
            var isPlaceholder = marker.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.MARKER_PLACEHOLDER.name());
    ...
    value: function _updateIconMarker(element, state) {
      ...
      if (!lineId) return;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Looking for icon marker with lineId ".concat(lineId), null, 3);
      // Find and update the icon marker (use cached version if available)
      var iconMarker = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.getIconMarker(lineId);
      if (iconMarker) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Updating icon marker state to ".concat(state), {
          lineId: lineId,
          currentClasses: Array.from(iconMarker.classList)
        }, 3);

        // Store the placeholder status before removing classes
        var isPlaceholder = iconMarker.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.MARKER_PLACEHOLDER.name());
        ...
        if (state === 'selected') {
          iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_SELECTED.name());

          // Add the side-appropriate selection icon class
          if (element.dataset.side === 'left') {
            iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT_LEFT.name());
          } else {
            iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.SELECT_RIGHT.name());
          }
        } else if (state === 'unselected') {
          iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].DIFF.CHUNK_UNSELECTED.name());
        } else {
          // Fallback for backward compatibility
        ...
        if (isPlaceholder && !iconMarker.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.MARKER_PLACEHOLDER.name())) {
          iconMarker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__["default"].ICONS.MARKER_PLACEHOLDER.name());
          _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Preserved placeholder marker status", null, 3);
        }
      } else {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.warn("ChunkVisualStateManager: No icon marker found for line ".concat(lineId), null, 3);
      }
    }
    ...
    value: function _notifySelectionChange() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: Notifying about selection change", null, 3);
      if (typeof this.chunkManager.onSelectionChange === 'function') {
        this.chunkManager.onSelectionChange();
      } else {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_2__.Debug.log("ChunkVisualStateManager: No onSelectionChange handler defined", null, 3);
      }
    }
...
/***/ "./src/components/chunks/MergeContentGenerator.js":
/*!********************************************************!*\
  !*** ./src/components/chunks/MergeContentGenerator.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MergeContentGenerator: () => (/* binding */ MergeContentGenerator)
/* harmony export */ });
/* harmony import */ var _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/ChunkUtils */ "./src/utils/ChunkUtils.js");
  ...
  */
  return _createClass(MergeContentGenerator, [{
    ...
    value: function extractChunkLines(chunkId, side) {
      ...
      if (!chunk) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("MergeContentGenerator: Chunk not found: ".concat(chunkId), null, 3);
        return [];
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log("MergeContentGenerator: Extracted ".concat(lines.length, " lines from chunk ").concat(chunkId, " (").concat(side, ")"), {
        chunkId: chunkId,
        side: side,
    ...
    value: function generateMergedContent(selections) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('MergeContentGenerator: Starting merge generation', {
      ...
      if (Object.keys(selections).length === 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('MergeContentGenerator: No selections, returning new content', null, 2);
        return _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.generateFileContent(this.chunkManager.newContent);
      }
      var mergedLines = [];
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('MergeContentGenerator: Processing complete', {
      ...
      var mergedContent = _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.generateFileContent(mergedLines);
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__.Debug.log('MergeContentGenerator: Merge generation complete', {
    ...
    value: function generateFileFromLines(lines) {
      return _utils_ChunkUtils__WEBPACK_IMPORTED_MODULE_0__.ChunkUtils.generateFileContent(lines);
    }
  }]);
}();
...
/***/ "./src/components/merge/MergeOperationHandler.js":
/*!*******************************************************!*\
  !*** ./src/components/merge/MergeOperationHandler.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MergeOperationHandler: () => (/* binding */ MergeOperationHandler)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/Debug */ "./src/utils/Debug.js");
/* harmony import */ var _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/TranslationManager */ "./src/utils/TranslationManager.js");
...
/* harmony import */ var _utils_AlertManager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/AlertManager */ "./src/utils/AlertManager.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
  ...
  return _createClass(MergeOperationHandler, [{
      ...
      var _proceedWithMerge = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(mergeType) {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Proceeding with merge', {
                mergeType: mergeType
              }, 2);
              ...
              if ((mergeType === 'new' || mergeType === 'new-suffix') && !fileRefId) {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Switching to clipboard mode (no fileRefId available)', null, 2);
                mergeType = 'clipboard';
              } else if ((mergeType === 'old' || mergeType === 'old-suffix') && !oldFileRefId) {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Switching to clipboard mode (no oldFileRefId available)', null, 2);
                mergeType = 'clipboard';
              } else if ((mergeType === 'both' || mergeType === 'both-suffix') && (!fileRefId || !oldFileRefId)) {
                _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Switching to clipboard mode (missing file reference IDs)', null, 2);
                mergeType = 'clipboard';
              }

              // Get translation manager for loading message
              translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_1__.TranslationManager.getInstance();
              loadingMessage = translationManager.get('loadingContent', 'Processing merge...'); // Show loading indicator
              loaderManager = _utils_LoaderManager__WEBPACK_IMPORTED_MODULE_2__.LoaderManager.getInstance();
              loaderId = loaderManager.showLoader(loadingMessage, {
                fullscreen: true,
            ...
            case 18:
              ...
              if (result.success) {
                ...
                if (resultContainer) {
                  ...
                  alertManager = _utils_AlertManager__WEBPACK_IMPORTED_MODULE_3__["default"].getInstance();
                ...
                if (_resultContainer) {
                  ...
                  _alertManager = _utils_AlertManager__WEBPACK_IMPORTED_MODULE_3__["default"].getInstance();
            ...
            case 23:
              ...
              loaderManager.hideLoader(loaderId);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('MergeOperationHandler: Error in merge operation', _context.t0, 1);
              ...
              if (_resultContainer2) {
                ...
                // Use AlertManager to show error message
                _alertManager2 = _utils_AlertManager__WEBPACK_IMPORTED_MODULE_3__["default"].getInstance();
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: File references for merge operation', {
                fileRefId: fileRefId,
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Switching to clipboard mode in applyMerge (missing file references)', null, 2);
              return _context2.abrupt("return", {
                success: true,
                message: _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_1__.TranslationManager.getInstance().get('mergeSuccessClipboard', 'Merge completed successfully. The merged content is ready.')
              });
            case 7:
              if (!((mergeType === 'new' || mergeType === 'new-suffix') && !fileRefId)) {
                _context2.next = 12;
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('MergeOperationHandler: No file reference ID available for new file', null, 1);
              return _context2.abrupt("return", {
                success: false,
            ...
            case 12:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('MergeOperationHandler: No file reference ID available for old file', null, 1);
              return _context2.abrupt("return", {
                success: false,
            ...
            case 17:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('MergeOperationHandler: Missing file reference IDs for both files', null, 1);
              return _context2.abrupt("return", {
                success: false,
            ...
            case 20:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Form parameters for save request', formParams, 2);
            ...
            case 29:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Using endpoint', {
                endpoint: endpoint
              }, 2);
            ...
            case 36:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: API response', result, 2);
              return _context2.abrupt("return", result);
            case 41:
              _context2.prev = 41;
              _context2.t0 = _context2["catch"](22);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("MergeOperationHandler: Error applying merge:", _context2.t0, 1);
              return _context2.abrupt("return", {
                success: false,
    ...
    value: function scrollToMergeResult() {
      ...
      if (resultElement) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeOperationHandler: Scrolled to merge result', null, 2);
      }
    }
  }]);
}();
...
/***/ "./src/components/merge/MergePreviewManager.js":
/*!*****************************************************!*\
  !*** ./src/components/merge/MergePreviewManager.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MergePreviewManager: () => (/* binding */ MergePreviewManager)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/Debug */ "./src/utils/Debug.js");
/* harmony import */ var _utils_MergeContentFormatter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/MergeContentFormatter */ "./src/utils/MergeContentFormatter.js");
...
/* harmony import */ var _syntax_CopyButton__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../syntax/CopyButton */ "./src/components/syntax/CopyButton.js");
...
var MergePreviewManager = /*#__PURE__*/function () {
  ...
  return _createClass(MergePreviewManager, [{
    ...
    value: function initialize() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergePreviewManager: Initialized', null, 2);
    }
    ...
    value: function setupPreviewButton() {
      ...
      var previewButton = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.BUTTON_PREVIEW.name());

      // If not found, check for the "Get merged result" button (used in local-only mode)
      var getMergedResultButton = !previewButton ? document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.GET_MERGED_RESULT_BTN.name()) : null;

      // Use whichever button is available
      var buttonToUse = previewButton || getMergedResultButton;
      if (!buttonToUse) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('MergePreviewManager: Preview button not found', null, 2);
        return;
      }
      ...
      if (buttonToUse === previewButton && (!newBtn.innerHTML || newBtn.innerHTML.trim() === '')) {
        newBtn.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__.DOMUtils.getIconHtml('eye', {
          classes: 'me-2'
        }) + 'Preview';
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergePreviewManager: ".concat(buttonToUse === previewButton ? 'Preview' : 'Get merged result', " button handler set up"), null, 3);
    }
    ...
    value: function handlePreviewClick() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergePreviewManager: Preview button clicked', null, 2);
      ...
      try {
        ...
        var formattedContent = _utils_MergeContentFormatter__WEBPACK_IMPORTED_MODULE_1__.MergeContentFormatter.formatPreview(mergedContent, extension, true);

        // Hide loading indicator now that content is ready
        loaderManager.hideLoader(loaderId);

        // Set the filename in the preview modal title using DOMUtils
        _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__.DOMUtils.setContent(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW_FILENAME.name(), this.diffViewer.runtimeProps.filepath || 'merged-file');

        // Use ModalManager to set content and open modal
        this.modalManager.setContent(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW.name(), formattedContent, _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW_CONTENT_ID.name());

        // Create controls container
        var controlsContainer = document.createElement('div');
        controlsContainer.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.FLEX.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.JUSTIFY_CONTENT_BETWEEN.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.MARGIN_TOP_2.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.PADDING_2.name());

        // Create message area
        var messageArea = document.createElement('div');
        messageArea.id = 'merge-preview-message';
        messageArea.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.FLEX.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.ALIGN_ITEMS_CENTER.name());
        controlsContainer.appendChild(messageArea);

        // Open the modal
        this.modalManager.open(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW.name());

        // Apply syntax highlighting if available
        this.applySyntaxHighlighting();

        // Add copy buttons to code blocks
        _syntax_CopyButton__WEBPACK_IMPORTED_MODULE_4__.CopyButton.addCopyButtonsToPreview(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW_CONTENT_ID.name());
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergePreviewManager: Preview opened successfully', null, 2);
      } catch (error) {
        // Hide loading indicator in case of error
        loaderManager.hideLoader(loaderId);
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('MergePreviewManager: Error during preview:', error, 2);
    ...
    value: function applySyntaxHighlighting() {
      if (!window.hljs) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergePreviewManager: Highlight.js not available', null, 3);
        return;
      }
      try {
        var _DOMUtils$getElement;
        // Use DOMUtils to get the preview element
        var preElement = (_DOMUtils$getElement = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__.DOMUtils.getElement(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW_CONTENT_ID.name())) === null || _DOMUtils$getElement === void 0 ? void 0 : _DOMUtils$getElement.querySelector('pre');
        var codeElement = preElement === null || preElement === void 0 ? void 0 : preElement.querySelector('code');
        if (!codeElement) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('MergePreviewManager: No code element found for highlighting', null, 2);
          return;
        }
        ...
        if (preElement.getAttribute('data-line-numbers') === 'true' && window.hljs.lineNumbersBlock) {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergePreviewManager: Line numbers added to preview', null, 3);
        }
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergePreviewManager: Syntax highlighting applied', null, 3);
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('MergePreviewManager: Error applying syntax highlighting:', error, 2);
      }
    }
    ...
    value: function showPreviewError(error) {
      ...
      var escapedError = _utils_StringUtils__WEBPACK_IMPORTED_MODULE_3__.StringUtils.escapeHtml(errorMessage);

      // First clear the modal content
      this.modalManager.setContent(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW.name(), '', _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW_CONTENT_ID.name());

      // Then use DOMUtils to show the message
      _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__.DOMUtils.showMessage(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW_CONTENT_ID.name(), "<h4>Error Generating Preview</h4><p>".concat(escapedError, "</p>"), 'danger', {
        className: ''
      } // No margin in modal
      );
      this.modalManager.open(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW.name());
...
/***/ "./src/components/merge/MergeUIController.js":
/*!***************************************************!*\
  !*** ./src/components/merge/MergeUIController.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MergeUIController: () => (/* binding */ MergeUIController)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/Debug */ "./src/utils/Debug.js");
/* harmony import */ var _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/DOMUtils */ "./src/utils/DOMUtils.js");
...
/* harmony import */ var _utils_NavigationUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utils/NavigationUtils */ "./src/utils/NavigationUtils.js");
/* harmony import */ var _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/TranslationManager */ "./src/utils/TranslationManager.js");
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../constants/Selectors */ "./src/constants/Selectors.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
...
var MergeUIController = /*#__PURE__*/function () {
  ...
  function MergeUIController(mergeHandler) {
    ...
    this.diffViewer = mergeHandler.diffViewer;
    this.modalManager = mergeHandler.modalManager;
    this.translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_4__.TranslationManager.getInstance();
  ...
  return _createClass(MergeUIController, [{
    ...
    value: function initialize() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Initialized', null, 2);
    }
    ...
    value: function initMergeDestinationToggle() {
      ...
      this.mergeDestination = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.getElement(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.DESTINATION_DROPDOWN);
      this.mergeToggleBtn = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.getElement(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.DESTINATION_TOGGLE);
      ...
      if (!this.mergeDestination || !this.mergeToggleBtn) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('MergeUIController: Missing merge destination elements', null, 2);
        return;
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Populating merge destination options', null, 2);
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Initial merge destination set to ".concat(this.mergeDestination.value), null, 2);

      // Set up event handlers
      this.setupMergeToggleEvents();
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Merge destination toggle initialized', null, 2);
    }
    ...
    value: function populateMergeDestinations() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: File names for merge destinations', {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Save options configuration', saveOptions, 3);
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Cleared existing dropdown options', null, 3);
      var optionCount = 0;

      // Add options based on configuration
      if (saveOptions.saveToOriginal) {
        _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.createAndAppendElement('option', this.mergeDestination, {
          attributes: {
            value: 'new',
      ...
      if (optionCount === 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: No save options enabled, adding default option', null, 2);
        _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.createAndAppendElement('option', this.mergeDestination, {
          attributes: {
            value: 'new',
            'data-tooltip': this.translationManager.get('saveToOriginalTooltip', 'Replace the current file with merged content')
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Populated merge destinations with ".concat(optionCount, " options"), null, 2);
    }
    ...
    value: function setupMergeToggleEvents() {
      ...
      var toggleHandler = function toggleHandler(event) {
        ...
        if (_this.mergeDestination) {
          ...
          if (typeof _this.mergeDestination.showPicker === 'function') {
            try {
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Opened dropdown using showPicker()', null, 3);
              return;
            } catch (e) {
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: showPicker() failed, trying alternative method', e, 2);
            }
          }
          ...
          setTimeout(function () {
            try {
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Failed to open dropdown with click event', e, 2);
            }
          }, 10);
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Toggle button clicked, attempting to open dropdown', null, 3);
      };
      var changeHandler = function changeHandler() {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Selection changed to ".concat(_this.mergeDestination.value), null, 3);
      };
      ...
      if (!this.mergeToggleBtn.querySelector('#vdm-merge-controls__toggle-icon')) {
        this.mergeToggleIcon = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.createAndAppendElement('i', this.mergeToggleBtn, {
      ...
      if (!this.mergeToggleBtn.querySelector('#vdm-merge-controls__toggle-text')) {
        this.mergeToggleText = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.createAndAppendElement('span', this.mergeToggleBtn, {
      ...
      dropdownIcon.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.MARGIN_START_2.name(); // Using the correct end start class
      dropdownIcon.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.getIconHtml('chevron-down', {
        width: 10,
        height: 10
      });
    ...
    value: function updateMergeToggle(value) {
      ...
      var newFileBtnClass = _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_PRIMARY.name(); // Purple button
      var oldFileBtnClass = _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_WARNING.name(); // Amber button
      var bothFilesBtnClass = _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_INFO.name(); // Turquoise button
      ...
      var iconClasses = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.MARGIN_END_1.name(), " ").concat(colorClass);
      this.mergeToggleIcon.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.getIconHtml(iconHtml, {
        classes: iconClasses
      });

      // Update the Apply Merge button style to match the destination
      var applyButton = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.BUTTON_APPLY.name());
      if (applyButton) {
        // Remove any existing button style classes
        applyButton.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_PRIMARY.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_WARNING.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_INFO.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_SUCCESS.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_DANGER.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_SECONDARY.name());

        // Add the appropriate button style class
        applyButton.classList.add(buttonClass);
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Updated apply button style to ".concat(buttonClass), null, 3);
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Toggle updated to ".concat(value), null, 3);
    }
    ...
    value: function setupModalButtons() {
      ...
      document.addEventListener('click', function (event) {
        ...
        if (event.target.closest && event.target.closest("#".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.CONTINUE_BTN.name()))) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Continue merging button clicked via delegation', null, 2);
          _this2.modalManager.close(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name());

          // Also close the preview modal - use MODAL.PREVIEW instead of MERGE.PREVIEW_MODAL
          var previewModalId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW.name();
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Also closing preview modal (ID: ".concat(previewModalId, ")"), null, 1);
        ...
        if (event.target.closest && event.target.closest("#".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.MERGE_BTN.name()))) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Merge anyway button clicked via delegation', null, 2);
          _this2.modalManager.close(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name());
      ...
      if (this.modalManager && typeof this.modalManager.registerBeforeOpenCallback === 'function') {
        this.modalManager.registerBeforeOpenCallback(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name(), function () {
          // Log the presence of the buttons when the modal opens
          var continueBtn = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.CONTINUE_BTN.name());
          var mergeBtn = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.MERGE_BTN.name());
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Modal opened, buttons present: continueBtn=".concat(!!continueBtn, ", mergeBtn=").concat(!!mergeBtn), null, 2);

          // Add direct click handlers (as a backup)
          if (continueBtn) {
            continueBtn.onclick = function () {
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Continue merging clicked via direct handler', null, 2);
              _this2.modalManager.close(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name());
          ...
          if (mergeBtn) {
            mergeBtn.onclick = function () {
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Merge anyway clicked via direct handler', null, 2);
              _this2.modalManager.close(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name());
              _this2.mergeHandler.proceedWithMerge(_this2.getMergeType());
              return false; // Prevent default
            };
    ...
    value: function setupApplyMergeButton() {
      ...
      var applyButton = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.BUTTON_APPLY.name());
      if (!applyButton) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('MergeUIController: Apply merge button not found', null, 2);
        return;
      }

      // Get the merge controls actions container
      var mergeControlsActions = document.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONTROLS_ACTIONS.toString());
      if (!mergeControlsActions) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('MergeUIController: Merge controls container not found', null, 2);
        return;
      }

      // Get the merge destination dropdown and toggle button
      var destinationDropdown = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.DESTINATION_DROPDOWN.name());
      var toggleButton = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.DESTINATION_TOGGLE.name());
      ...
      if (mergeControlsActions.parentNode) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Created form wrapper for merge controls', null, 2);
      }
      ...
      form.addEventListener('submit', function (event) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Form submitted', null, 3);
      });
      ...
      if (toggleButton) {
        ...
        toggleButton.addEventListener('click', function (event) {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Toggle button click intercepted to prevent form submission', null, 3);
        });
      }
      ...
      applyButton.addEventListener('click', function (event) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Apply merge clicked', null, 3);
      });
    }
    ...
    value: function handleApplyMerge() {
      ...
      if (unresolvedCount > 0) {
        ...
        if (!fileRefId && !oldFileRefId) {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Using clipboard merge type for non-file-browser mode', null, 2);
          this.mergeHandler.proceedWithMerge('clipboard');
        } else {
          // Use selected merge type for file-browser mode
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Using selected merge type for file-browser mode', null, 2);
    ...
    value: function showConflictModal(unresolvedCount) {
      ...
      var message = _utils_MergeContentFormatter__WEBPACK_IMPORTED_MODULE_2__.MergeContentFormatter.formatUnresolvedCount(unresolvedCount, translations);

      // Open the conflict modal
      this.modalManager.open(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name());

      // Set the message in the modal
      setTimeout(function () {
        _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.showMessage(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.MESSAGE.name(), message, 'warning', {
          className: '' // No extra margin needed in modal
        });
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Showing conflict modal with message', null, 2);
      }, 50);
      ...
      setTimeout(function () {
        ...
        if (continueBtn) {
          ...
          newContinueBtn.addEventListener('click', function () {
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Continue button clicked', null, 2);

            // First close the conflict modal
            _this4.modalManager.close(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name());

            // Then close the preview modal
            var previewModalId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MODAL.PREVIEW.name();
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Closing preview modal (ID: ".concat(previewModalId, ")"), null, 2);
        ...
        if (mergeBtn) {
          ...
          newMergeBtn.addEventListener('click', function () {
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Merge anyway button clicked', null, 2);
            _this4.modalManager.close(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONFLICT_MODAL.name());
    ...
    value: function highlightUnresolvedChunks() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Finding first unresolved conflict', null, 2);
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (chunk.conflict && !selections[chunk.id]) {
            ...
            if (this.diffViewer.diffNavigator) {
              ...
              if (chunkElement) {
                _utils_NavigationUtils__WEBPACK_IMPORTED_MODULE_3__.NavigationUtils.addHighlightEffect(chunkElement, 4000);
              }
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("MergeUIController: Highlighted unresolved chunk ".concat(chunk.id), null, 2);
              return true;
            }
          }
        }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: No unresolved conflicts found', null, 2);
      return false;
    }
    ...
    value: function setupLocalOnlyControls() {
      var _this5 = this;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Setting up local-only controls (server save disabled)', null, 2);

      // Get translations using the TranslationManager
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Getting translations for local-only controls', this.translationManager, 2);
      ...
      var mergeControlsActions = document.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.CONTROLS_ACTIONS.toString());
      if (!mergeControlsActions) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('MergeUIController: Could not find merge controls container', null, 1);
        return;
      }
      ...
      getMergedResultBtn.id = _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].MERGE.GET_MERGED_RESULT_BTN.name();
      getMergedResultBtn.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.BUTTON_PRIMARY.name());
      getMergedResultBtn.title = getMergedResultTooltip;

      // Add download icon and text using the proper icon system
      var downloadIconHtml = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.getIconHtml('download', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.MARGIN_END_1.name()
      });
      getMergedResultBtn.innerHTML = "".concat(downloadIconHtml, " ").concat(getMergedResultText);

      // Add to container (align to right)
      var buttonContainer = document.createElement('div');
      buttonContainer.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.FLEX.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_5__["default"].UTILITY.JUSTIFY_CONTENT_BETWEEN.name(), " w-100");
      ...
      getMergedResultBtn.addEventListener('click', function (event) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Get merged result button clicked (using clipboard merge type)', null, 2);
      });
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('MergeUIController: Local-only controls setup complete', null, 2);
    }
  }]);
}();
...
/***/ "./src/components/modal/ModalManager.js":
/*!**********************************************!*\
  !*** ./src/components/modal/ModalManager.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var ModalManager = /*#__PURE__*/function (_BaseSingleton) {
  ...
  function ModalManager() {
    ...
    _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Initialized', null, 2);
    return _this;
  }
  ...
  return _createClass(ModalManager, [{
    ...
    value: function initModals() {
      try {
        if (this.initialized) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Already initialized', null, 2);
          return true;
        }
        var translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_4__.TranslationManager.getInstance();
        ...
        this.createModal({
          id: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONFIRM.name(),
          title: translationManager.get('confirmation'),
          contentId: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.MESSAGE.name(),
          contentClass: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.PADDING_3.name(),
          footerButtons: [{
            id: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTINUE_BTN.name(),
            text: translationManager.get('continueResolving'),
            "class": _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name() + ' ' + _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name() + ' ' + _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.MARGIN_END_2.name()
          }, {
            id: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.MERGE_BTN.name(),
            text: translationManager.get('mergeAnyway'),
            "class": _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name() + ' ' + _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_WARNING.name()
          }]
        });

        // Create preview modal
        this.createModal({
          id: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.PREVIEW.name(),
          title: '<span id="' + _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.PREVIEW_FILENAME.name() + '"></span>',
          contentId: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.PREVIEW_CONTENT_ID.name(),
          contentClass: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.PREVIEW_CONTENT.name(),
          headerClass: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.HEADER_FIXED.name(),
        ...
        this.createModal({
          id: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MERGE.CONFLICT_MODAL.name(),
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Modals initialized', null, 2);
        return true;
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('ModalManager: Error initializing modals', error, 1);
        return false;
      }
    }
    ...
    value: function createModal(config) {
      try {
        ...
        if (document.getElementById(modalId)) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Modal ".concat(modalId, " already exists in DOM"), null, 2);
          return true;
        }

        // Use header class from config or default to MODAL.HEADER with prefix removed
        var headerClass = config.headerClass || _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.HEADER.name();

        // Start building modal HTML
        var modalHtml = "\n                <div id=\"".concat(modalId, "\" class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTAINER.name() /*remove dot prefix*/).concat(config.modalClass ? ' ' + config.modalClass : '', "\" style=\"display: none;\"");
        ...
        modalHtml += ">\n                    <div class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTENT.name(), "\">\n                        <div class=\"").concat(headerClass, "\">\n                            <h5 class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.TITLE.name(), "\">").concat(config.title, "</h5>\n                            <button class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CLOSE.name(), "\">&times;</button>\n                        </div>");
        ...
        if (config.footerButtons && config.footerButtons.length > 0) {
          modalHtml += "<div class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.FOOTER.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.FLEX.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.JUSTIFY_CONTENT_BETWEEN.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.PADDING_3.name(), "\">");
          config.footerButtons.forEach(function (button) {
            ...
            var isCloseButton = button === null || button === void 0 ? void 0 : button["class"].split(' ').includes(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CLOSE.name());
            ...
            if (button.id) {
              if (button.id.toLowerCase().includes('copy')) {
                iconName = 'copy';
              } else if (button.id === _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTINUE_BTN.name()) {
                iconName = 'chevron-right';
              } else if (button.id === _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.MERGE_BTN.name()) {
                iconName = 'exclamation-circle';
              }
            }
            ...
            var iconHtml = '';
            if (!isCloseButton) {
              iconHtml = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_3__.DOMUtils.getIconHtml(iconName, {
                classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.MARGIN_END_2.name()
              });
            }
            modalHtml += "<button id=\"".concat(button.id, "\" class=\"").concat(button["class"] || _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name() + ' ' + _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SECONDARY.name(), "\"");
        ...
        if (config.events) {
          ...
          Object.entries(config.events).forEach(function (_ref5) {
            ...
            if (selector === 'modal') {
              ...
              elements = Array.from(_modalElement.querySelectorAll(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CLOSE));
            } else {
            ...
            elements.forEach(function (element) {
              if (element) {
                Object.entries(events).forEach(function (_ref7) {
                  ...
                  _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Attached ".concat(eventName, " event to ").concat(selector, " in modal ").concat(modalId), null, 3);
                });
              }
            });
          });
        }
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Created modal - ".concat(modalId), null, 3);
        return true;
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Error creating modal - ".concat(config.id), error, 1);
        return false;
      }
    }
    ...
    value: function _appendToBody(modalId, html) {
      ...
      var backdrop = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.BACKDROP.name());
      if (!backdrop) {
        backdrop = document.createElement('div');
        backdrop.id = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.BACKDROP.name();
    ...
    value: function _setupEventListeners() {
      ...
      document.addEventListener('click', function (event) {
        ...
        if (event.target.matches(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CLOSE)) {
          var modal = event.target.closest(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTAINER);
    ...
    value: function register(modalId) {
      ...
      try {
        ...
        if (!element) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn("ModalManager: Element not found for modal ID ".concat(modalId), null, 2);
          return false;
        }
        this.modals[modalId] = {
          element: element,
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Registered modal - ".concat(modalId), null, 3);
        return true;
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Error registering modal - ".concat(modalId), error, 1);
        return false;
      }
    }
    ...
    value: function registerBeforeOpenCallback(modalId, callback) {
      try {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Registered before-open callback for modal ".concat(modalId), null, 2);
        return true;
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Error registering before-open callback for modal ".concat(modalId), error, 1);
        return false;
      }
    }
    ...
    value: function open(modalId) {
      try {
        ...
        if (!modal) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn("ModalManager: Cannot open modal ".concat(modalId, " - not registered"), null, 2);

          // Forcefully try to find the modal element even if not registered
          var element = document.getElementById(modalId);
          if (element) {
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Found unregistered modal element ".concat(modalId, ", registering now"), null, 2);
        ...
        if (modal.beforeOpenCallbacks && modal.beforeOpenCallbacks.length > 0) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Executing ".concat(modal.beforeOpenCallbacks.length, " before-open callbacks for modal ").concat(modalId), null, 2);
          modal.beforeOpenCallbacks.forEach(function (callback) {
            try {
              callback();
            } catch (err) {
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Error in before-open callback for modal ".concat(modalId), err, 1);
            }
          });
        }
        this._showModal(modalId);
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Error opening modal ".concat(modalId, ":"), error, 2);
        return false;
      }
    }
    ...
    value: function _showModal(modalId) {
      var modal = this.modals[modalId];
      if (!modal) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn("ModalManager: Modal ".concat(modalId, " not found"), null, 2);
        return;
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Setting modal ".concat(modalId, " display to block"), {
      ...
      setTimeout(function () {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Fading in modal ".concat(modalId), null, 3);
      }, 10);
      modal.isOpen = true;

      // Handle fullscreen if needed
      if (modalId === _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.PREVIEW.name()) {
    ...
    value: function close(modalId) {
      try {
        if (!this.modals[modalId]) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn("ModalManager: Modal not found - ".concat(modalId), null, 2);
          return false;
        }
        this._hideModal(modalId);
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Closed modal - ".concat(modalId), null, 3);
        return true;
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Error closing modal - ".concat(modalId), error, 1);
        return false;
      }
    }
    ...
    value: function setContent(modalId, content) {
      ...
      try {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Setting content for modal ".concat(modalId), {
        ...
        var modal = this.modals[modalId];
        if (!modal) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Modal not found - ".concat(modalId), null, 1);
          return false;
        }
        ...
        if (contentSelector) {
          var _container;
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Looking for content container with selector: ".concat(contentSelector), null, 2);
          ...
          if (!contentSelector.startsWith('#') && !contentSelector.startsWith('.')) {
            ...
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Tried getElementById with: ".concat(contentSelector, ", found: ").concat(!!container), null, 2);
          }

          // If not found or not an ID, try as a selector
          if (!container) {
            container = document.querySelector(contentSelector);
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Tried querySelector with: ".concat(contentSelector, ", found: ").concat(!!container), null, 2);
          }

          // Log container details
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Container lookup result:", {
            found: !!container,
          ...
          container = modal.element.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTENT);
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Using default content container:", {
            found: !!container,
            selector: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTENT
          }, 2);
          if (!container) {
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Content container not found - ".concat(modalId), null, 1);
            return false;
          }
        }
        if (!container) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Could not find content container with selector: ".concat(contentSelector), null, 1);
          return false;
        }

        // Set the content
        if (typeof content === 'string') {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Setting HTML content for modal ".concat(modalId), {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Content set verification:", {
            hasPreElements: hasPreElements,
            innerHTML: container.innerHTML.substring(0, 100) + '...'
          }, 2);
          if (content.includes('<pre') && !hasPreElements) {
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn("ModalManager: Content included <pre> tags but none found after setting innerHTML", {
              innerHtmlLength: container.innerHTML.length
            }, 1);
          }
        } else if (content instanceof Element) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Setting Element content for modal ".concat(modalId), {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Invalid content type - ".concat(_typeof(content)), null, 1);
          return false;
        }
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ModalManager: Content set for modal - ".concat(modalId), null, 3);
        return true;
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error("ModalManager: Error setting content - ".concat(modalId), error, 1);
        return false;
      }
    }
    ...
    value: function setFullscreenSize(modalElement) {
      try {
        if (!modalElement) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('ModalManager: Modal element not provided for fullscreen', null, 2);
          return false;
        }

        // Add fullscreen class
        modalElement.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.FULLSCREEN.name());

        // Calculate and set the height
        var headerHeight = modalElement.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.HEADER) ? modalElement.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.HEADER).offsetHeight : 0;
        var content = modalElement.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTENT);
        if (content) {
          content.style.height = "calc(100% - ".concat(headerHeight, "px)");
        }
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Modal set to fullscreen size', null, 3);
        return true;
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('ModalManager: Error setting fullscreen size', error, 1);
        return false;
      }
    }
    ...
    value: function createCopyModal(codeText) {
      var _this4 = this;
      var modalId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CODE_COPY.name();
      // Get translations
      var translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_4__.TranslationManager.getInstance();
      ...
      if (!this.modals[modalId]) {
        this.createModal({
          ...
          contentId: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.COPY_CONTENT.name(),
          modalClass: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.FIXED_FOOTER.name(),
          headerClass: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.HEADER_FIXED.name(),
          footerButtons: [{
            "class": "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CLOSE.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SECONDARY.name())
          }]
        });
      }
      ...
      var content = "\n            <div class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.DIALOG.name(), "\">\n                <p class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.INSTRUCTIONS.name(), "\">").concat(translationManager.get('copyInstructions'), "</p>\n                <div class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.TEXTAREA.name(), "\">\n                    <textarea id=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.TEXTAREA_ELEM.name(), "\" class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.TEXTAREA_ELEM.name(), "\">").concat(safeText, "</textarea>\n                </div>\n                <div class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.ACTIONS.name(), "\">\n                    <button id=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.BUTTON.name(), "\" class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name(), "\">\n                        ").concat(_utils_DOMUtils__WEBPACK_IMPORTED_MODULE_3__.DOMUtils.getIconHtml('copy', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.MARGIN_END_2.name()
      }), "\n                        <span>").concat(translationManager.get('copyToClipboard'), "</span>\n                    </button>\n                </div>\n            </div>\n        ");

      // Set content
      this.setContent(modalId, content, _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.COPY_CONTENT.name());

      // Set up event handlers after a short delay to ensure DOM is ready
      setTimeout(function () {
        var textarea = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.TEXTAREA_ELEM.name());
        var copyBtn = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].COPY.MODAL.BUTTON.name());
        if (textarea) {
            ...
            try {
              ...
              if ((_navigator$clipboard = navigator.clipboard) !== null && _navigator$clipboard !== void 0 && _navigator$clipboard.writeText) {
                navigator.clipboard.writeText(textarea.value).then(function () {
                  ...
                  _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Successfully copied using Clipboard API', null, 3);
                })["catch"](function (_err) {
                  ...
                  if (success) {
                    _this5._showCopySuccess(copyBtn);
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Successfully copied using execCommand fallback', null, 3);
                  } else {
                    _this5._showCopyFailure(copyBtn);
                    _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('ModalManager: Copy failed with execCommand fallback', null, 2);
                  }
                });
              } else {
                ...
                if (success) {
                  ...
                  _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Successfully copied using execCommand', null, 3);
                } else {
                  this._showCopyFailure(copyBtn);
                  _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('ModalManager: Copy failed with execCommand', null, 2);
                }
              }
            } catch (err) {
              this._showCopyFailure(copyBtn);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('ModalManager: Error during copy operation', err, 2);
            }
    ...
    value: function _showCopySuccess(button) {
      var translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_4__.TranslationManager.getInstance();
      button.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_3__.DOMUtils.getIconHtml('check-circle', {
        classes: 'vdm-icon--success ' + _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.MARGIN_END_2.name()
      }) + "<span>".concat(translationManager.get('copied'), "</span>");
      button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name());
      button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SUCCESS.name());
      setTimeout(function () {
        button.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_3__.DOMUtils.getIconHtml('copy', {
          classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.MARGIN_END_2.name()
        }) + "<span>".concat(translationManager.get('copyToClipboard'), "</span>");
        button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SUCCESS.name());
        button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name());
      }, 2000);
    }
    ...
    value: function _showCopyFailure(button) {
      var translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_4__.TranslationManager.getInstance();
      button.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_3__.DOMUtils.getIconHtml('exclamation-triangle', {
        classes: 'vdm-icon--danger ' + _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.MARGIN_END_2.name()
      }) + "<span>".concat(translationManager.get('copyFailed'), "</span>");
      button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name());
      button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_DANGER.name());
      setTimeout(function () {
        button.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_3__.DOMUtils.getIconHtml('copy', {
          classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.MARGIN_END_2.name()
        }) + "<span>".concat(translationManager.get('tryAgain'), "</span>");
        button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_DANGER.name());
        button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name());
      }, 2000);
    }
    ...
    value: function createAndOpenModal(config, content) {
      ...
      try {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('ModalManager: Error creating and opening modal', error, 1);
        return null;
      }
    }
    ...
    value: function createConfirmationModal(options) {
      ...
      this.createModal({
        ...
        footerButtons: [{
          ...
          "class": "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CLOSE.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SECONDARY.name(), " me-2")
        }, {
          id: "".concat(modalId, "-confirm-btn"),
          text: options.confirmText || 'Confirm',
          "class": "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name())
        }],
    ...
    value: function createAlertModal(options) {
      var _this7 = this;
      var modalId = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTAINER.name(), "--alert-").concat(Date.now());

      // Determine alert class based on type
      var alertClass = options.type ? "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.ALERT, " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.ALERT_PREFIX).concat(options.type) : "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.ALERT, " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.ALERT_INFO);

      // Create modal
      this.createModal({
        id: modalId,
        title: options.title || 'Alert',
        contentId: "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTAINER.name(), "__alert-content"),
        contentClass: _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.PADDING_3.name(),
        footerButtons: [{
          id: "".concat(modalId, "-ok-btn"),
          text: options.buttonText || 'OK',
          "class": "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CLOSE.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_PRIMARY.name())
        }],
      ...
      // Set content
      this.setContent(modalId, alertContent, "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].MODAL.CONTAINER.name(), "__alert-content"));
    ...
    value: function destroy() {
      try {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ModalManager: Destroyed', null, 2);
      } catch (error) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.error('ModalManager: Error during destroy', error, 1);
      }
    }
  }], [{
    key: "getInstance",
...
/***/ "./src/components/navigator/ConflictNavigator.js":
/*!*******************************************************!*\
  !*** ./src/components/navigator/ConflictNavigator.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ConflictNavigator: () => (/* binding */ ConflictNavigator)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/Debug */ "./src/utils/Debug.js");
/* harmony import */ var _utils_NavigationUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/NavigationUtils */ "./src/utils/NavigationUtils.js");
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../constants/Selectors */ "./src/constants/Selectors.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _createForOfIteratorHelper(r, e) { var t = "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (!t) { if (Array.isArray(r) || (t = _unsupportedIterableToArray(r)) || e && r && "number" == typeof r.length) { t && (r = t); var _n = 0, F = function F() {}; return { s: F, n: function n() { return _n >= r.length ? { done: !0 } : { done: !1, value: r[_n++] }; }, e: function e(r) { throw r; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var o, a = !0, u = !1; return { s: function s() { t = t.call(r); }, n: function n() { var r = t.next(); return a = r.done, r; }, e: function e(r) { u = !0, o = r; }, f: function f() { try { a || null == t["return"] || t["return"](); } finally { if (u) throw o; } } }; }
function _toConsumableArray(r) { return _arrayWithoutHoles(r) || _iterableToArray(r) || _unsupportedIterableToArray(r) || _nonIterableSpread(); }
  ...
  return _createClass(ConflictNavigator, [{
    ...
    value: function _getUnresolvedChunkInfo() {
      ...
      var unresolvedElements = Array.from(document.querySelectorAll("[data-chunk-id]:not([data-chunk-id=\"\"])")).filter(function (el) {
        return el.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].STATUS.UNRESOLVED.name());
      });
      if (unresolvedElements.length === 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ConflictNavigator: No unresolved elements found', null, 2);
        return {
          unresolvedChunkIds: [],
          count: 0
        };
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ConflictNavigator: Found ".concat(unresolvedChunkIds.length, " unresolved chunks"), null, 3);
      return {
    ...
    value: function navigateToFirstConflict() {
      ...
      if (count === 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ConflictNavigator: No unresolved chunks found', null, 2);
        return false;
      }
      ...
      if (firstUnresolvedIndex >= 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ConflictNavigator: Navigating to first unresolved chunk at index ".concat(firstUnresolvedIndex), null, 2);
        return this.navigator.navigateToChunk(firstUnresolvedIndex);
      }
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ConflictNavigator: No matching chunk found', null, 2);
      return false;
    }
    ...
    value: function navigateToNextConflict() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ConflictNavigator: Current chunk index is ".concat(currentIndex), null, 3);
      ...
      if (nextIndex >= 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ConflictNavigator: Navigating to next unresolved chunk at index ".concat(nextIndex), null, 2);
    ...
    value: function navigateToPrevConflict() {
      ...
      if (prevIndex >= 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ConflictNavigator: Navigating to previous unresolved chunk at index ".concat(prevIndex), null, 2);
    ...
    value: function navigateToChunk(index) {
      ...
      // Scroll to it
      if (chunkElement) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log("ConflictNavigator: Navigating to chunk ".concat(index), null, 2);

        // Find the diff-pane-content containing this element
        var paneContent = chunkElement.closest(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE_CONTENT);
        if (paneContent) {
          // Use utility to scroll element into view
          _utils_NavigationUtils__WEBPACK_IMPORTED_MODULE_1__.NavigationUtils.scrollElementIntoView(chunkElement, paneContent);

          // Add highlight effect
          _utils_NavigationUtils__WEBPACK_IMPORTED_MODULE_1__.NavigationUtils.addHighlightEffect(chunkElement, 2000);
        } else {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn("ConflictNavigator: Cannot navigate - chunk ".concat(index, " parent not found"), null, 2);
          return false;
        }
      } else {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn("ConflictNavigator: Cannot scroll - chunk ".concat(index, " not found"), null, 2);
        return false;
      }

      // Update counter
      this.navigator.navigationCounter.updateCounter();
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('ConflictNavigator: Navigation complete', null, 2);
      return true;
    }
  }]);
}();
...
/***/ "./src/components/navigator/NavigationCounter.js":
/*!*******************************************************!*\
  !*** ./src/components/navigator/NavigationCounter.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NavigationCounter: () => (/* binding */ NavigationCounter)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
/***/ "./src/components/navigator/NavigationUIBuilder.js":
/*!*********************************************************!*\
  !*** ./src/components/navigator/NavigationUIBuilder.js ***!
  \*********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NavigationUIBuilder: () => (/* binding */ NavigationUIBuilder)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utils/Debug */ "./src/utils/Debug.js");
/* harmony import */ var _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utils/DOMUtils */ "./src/utils/DOMUtils.js");
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../constants/Selectors */ "./src/constants/Selectors.js");
...
var NavigationUIBuilder = /*#__PURE__*/function () {
  ...
  return _createClass(NavigationUIBuilder, [{
    ...
    value: function createNavigationUI() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('NavigationUIBuilder: Creating navigation UI', null, 2);

      // Find container element - first look for an existing one
      var container = document.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.CONTAINER);

      // If no container found, create one
      if (!container) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('NavigationUIBuilder: No navigation container found, creating one', null, 2);

        // Get the diff pane contents as parent reference
        var panes = document.querySelectorAll(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].DIFF.PANE);
        if (!panes || panes.length === 0) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.warn('NavigationUIBuilder: No diff panes found to append navigation container');
          return null;
        }

        // Create container
        container = document.createElement('div');
        container.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.CONTAINER.name();
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('NavigationUIBuilder: Using existing navigation container', null, 2);
        container.innerHTML = '';
        this._createControls(container);
      }
      ...
      return {
        counter: document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.COUNTER.name()),
        prevButton: document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.PREV_BUTTON.name()),
        nextButton: document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.NEXT_BUTTON.name())
      };
    }
    ...
    value: function _createControls(container) {
      ...
      navChunk.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.NAV_CHUNK.name();

      // Create counter element
      var counter = document.createElement('span');
      counter.id = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.COUNTER.name();
      counter.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.COUNTER_ELEMENT.name();

      // Create previous button
      var prevButton = document.createElement('button');
      prevButton.id = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.PREV_BUTTON.name();
      prevButton.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_FLAT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SMALL.name());
      prevButton.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.getIconHtml('chevron-up');
      ...
      nextButton.id = _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.NEXT_BUTTON.name();
      nextButton.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_FLAT.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].UTILITY.BUTTON_SMALL.name());
      nextButton.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__.DOMUtils.getIconHtml('chevron-down');
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('NavigationUIBuilder: Navigation controls created', null, 2);
    }
    ...
    value: function destroy() {
      ...
      var prevButton = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.PREV_BUTTON.name());
      var nextButton = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__["default"].NAVIGATION.NEXT_BUTTON.name());
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__.Debug.log('NavigationUIBuilder: Event handlers removed', null, 2);
    }
  }]);
}();
...
//# sourceMappingURL=diff-viewer-src_components_ch.js.map