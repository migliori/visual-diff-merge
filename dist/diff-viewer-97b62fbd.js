...
/* harmony export */   D: () => (/* binding */ LoaderManager)
/* harmony export */ });
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(762);
/* harmony import */ var _Debug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(979);
/* harmony import */ var _BaseSingleton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(454);
/* harmony import */ var _TranslationManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(428);
...
var LoaderManager = /*#__PURE__*/function (_BaseSingleton) {
  ...
  return _createClass(LoaderManager, [{
    ...
    function initialize() {
      ...
      this.verboseLogging = _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.isInitialized ? _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.logLevel > 2 : false;
    ...
    value: function _createLoaderElement(message) {
      ...
      if (message && typeof message === 'string' && message.startsWith('$') && _TranslationManager__WEBPACK_IMPORTED_MODULE_2__/* .TranslationManager */ .n.getInstance().isInitialized()) {
        var translationKey = message.substring(1);
        var translatedMessage = _TranslationManager__WEBPACK_IMPORTED_MODULE_2__/* .TranslationManager */ .n.getInstance().get(translationKey);
    ...
    value: function showLoader() {
      ...
      if (this.isMainLoaderActive && this.mainLoaderId && options.fullscreen) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Reusing main loader for fullscreen request', {
          message: message
        }, 3);
        this.updateLoaderMessage(this.mainLoaderId, message);
        return this.mainLoaderId;
      }
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Showing loader', {
        message: message,
        options: options
      }, 3);
    ...
    value: function showMainLoader() {
      var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Loading...';
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Showing main loader', {
        message: message
      }, 2);
      ...
      if (this.isMainLoaderActive && this.mainLoaderId && this.activeLoaders.has(this.mainLoaderId)) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Main loader already active, updating message', {
      ...
      var mainLoaderElement = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.LOADER.MAIN.name());
      if (mainLoaderElement) {
        // If the element already exists in the DOM, just show it
        mainLoaderElement.style.display = 'flex';
        mainLoaderElement.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.LOADER.ACTIVE.name());
        ...
        var _loaderId = this.showLoader(message, _objectSpread({
          fullscreen: true,
          className: _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.LOADER.MAIN.name(),
          zIndex: 9999
        }, options));
        ...
        if (loaderInfo) {
          ...
          loaderInfo.element.id = _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.LOADER.MAIN.name();
        }
    ...
    value: function showEarlyLoader() {
      ...
      if (_Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.isInitialized) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Showing early loader', {
          message: message
        }, 2);
      }
    ...
    value: function adoptEarlyLoader() {
      ...
      if (!this.isMainLoaderActive || !this.mainLoaderId) {
        if (_Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.isInitialized) {
          _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: No early loader to adopt, creating new main loader', null, 2);
        }
      ...
      if (_Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.isInitialized) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Adopted early loader as main loader', {
    ...
    value: function hideMainLoader() {
      ...
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Hiding main loader', {
        loaderId: loaderId
      }, 2);

      // Special handling: If this was recently removed, just return success
      if (loaderId && this.recentlyRemovedLoaders.has(loaderId)) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Main loader was recently removed', {
          loaderId: loaderId
        }, 2);
        return true;
      }
      ...
      if (!this.isMainLoaderActive) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Main loader not active, nothing to hide', null, 2);
        return true;
      }
      ...
      if (loaderId && loaderId !== this.mainLoaderId) {
        ...
        if (!(loaderInfo !== null && loaderInfo !== void 0 && loaderInfo.isMainLoader)) {
          _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Using stored main loader ID', {
            providedId: loaderId,
      ...
      if (!loaderId || !this.activeLoaders.has(loaderId)) {
        ...
        if (mainLoaderElement) {
          ...
          _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Removed main loader by element ID', null, 2);
        }
    ...
    value: function _hideAllInlineLoaders() {
      var _this = this;
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Hiding all inline loaders', null, 3);
    ...
    value: function hideLoader(loaderId) {
      ...
      if (!loaderId) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Hiding all loaders', null, 3);
      ...
      if (this.recentlyRemovedLoaders.has(loaderId)) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Loader was recently removed', {
          loaderId: loaderId
        }, 2);
        return true;
      }
      ...
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Hiding loader', {
        loaderId: loaderId
      }, 3);
      var success = this._hideSpecificLoader(loaderId);
      if (success) {
    ...
    value: function _hideSpecificLoader(loaderId) {
      ...
      // Special handling: If this was recently removed, just return success
      if (this.recentlyRemovedLoaders.has(loaderId)) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Loader was recently removed (in _hideSpecificLoader)', {
          loaderId: loaderId
        }, 3);
        return true;
      }
      ...
      if (!loader) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: No loader found to hide', {
          loaderId: loaderId
        }, 2);
        return false;
      }
      ...
      if (!((_loader$element = loader.element) !== null && _loader$element !== void 0 && _loader$element.parentNode)) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Loader element was already removed from DOM', {
          loaderId: loaderId
        }, 3);
        return true;
      }
    ...
    value: function updateLoaderMessage(loaderId, message) {
      ...
      if (!loaderId && this.isMainLoaderActive && this.mainLoaderId) {
        loaderId = this.mainLoaderId;
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Using main loader ID for message update', {
      ...
      if (!loader) {
        ...
        if (this.verboseLogging) {
          _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: No loader found to update message', {
            loaderId: loaderId
          }, 2);
        }
        return false;
      ...
      if (!((_loader$element2 = loader.element) !== null && _loader$element2 !== void 0 && _loader$element2.parentNode)) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('LoaderManager: Loader element was removed from DOM', {
          loaderId: loaderId
        }, 3);
        this.activeLoaders["delete"](loaderId);
        this.recentlyRemovedLoaders.add(loaderId);
...
}(_BaseSingleton__WEBPACK_IMPORTED_MODULE_3__/* .BaseSingleton */ .t);
/* unused harmony default export */ var __WEBPACK_DEFAULT_EXPORT__ = ((/* unused pure expression or super */ null && (LoaderManager)));
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   c: () => (/* binding */ ConfigUtils)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   a: () => (/* binding */ NavigationUtils)
/* harmony export */ });
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(762);
/* harmony import */ var _Debug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(979);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
  ...
  return _createClass(NavigationUtils, null, [{
    ...
    function scrollElementIntoView(element, container) {
      if (!element || !container) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn('NavigationUtils: Missing element or container for scrolling', null, 2);
        return false;
      }
    ...
    value: function addHighlightEffect(element) {
      ...
      if (!element) return;
      element.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.NAVIGATION.HIGHLIGHT.name());
      setTimeout(function () {
        element.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.NAVIGATION.HIGHLIGHT.name());
      }, duration);
    }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   n: () => (/* binding */ TranslationManager)
/* harmony export */ });
/* harmony import */ var _BaseSingleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(454);
  ...
  return _createClass(TranslationManager, [{
    ...
    value: function _initializeFromGlobalConfig() {
      if (window.diffConfig && window.diffConfig.translations) {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('TranslationManager: Auto-initializing from window.diffConfig', window.diffConfig.translations, 2);
    ...
    value: function initialize() {
      ...
      this.initialized = true;
      _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("TranslationManager: Initialized with \"".concat(lang, "\" language"), this.translations, 2);
    }
    ...
    value: function get(key) {
      ...
      if (this.translations['en'] && this.translations['en'][key]) {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("TranslationManager: Key \"".concat(key, "\" not found in \"").concat(this.lang, "\", using English fallback"), null, 2);
    ...
    function getInstance() {
      if (!TranslationManager._instance) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('TranslationManager: Instance created', null, 2);
      }
      return TranslationManager._instance;
    }
  }]);
}(_BaseSingleton__WEBPACK_IMPORTED_MODULE_1__/* .BaseSingleton */ .t);
/**
 * @private
 * Singleton instance
 */
...
var DiffConfigManager = /*#__PURE__*/function () {
  ...
  function DiffConfigManager() {
    ...
    if (typeof window !== 'undefined' && !window.diffConfig) {
      _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Initializing empty window.diffConfig', null, 2);
      window.diffConfig = {
        debug: false,
        logLevel: 1,
        old: {},
      ...
      _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Using existing window.diffConfig', window.diffConfig, 2);
    }
  }
  ...
  return _createClass(DiffConfigManager, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Server config already loaded, skipping', null, 2);
            ...
            case 3:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Server config already loaded with apiBaseUrl', window.diffConfig.apiBaseUrl, 2);
              this._serverConfigLoaded = true;
              return _context.abrupt("return");
            case 7:
              _context.prev = 7;
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Loading server configuration...', null, 2);
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Could not determine API base URL from script location', null, 2);
              return _context.abrupt("return");
            case 15:
              _context.next = 17;
            ...
            case 21:
              ...
              if (serverConfig && _typeof(serverConfig) === 'object') {
                _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Loaded server configuration', serverConfig, 2);
                if (typeof window !== 'undefined') {
                  ...
                  if (existingServerSaveEnabled !== undefined && !serverConfig.hasOwnProperty('serverSaveEnabled')) {
                    ...
                    _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Preserved existing serverSaveEnabled', existingServerSaveEnabled, 2);
                  }
              ...
              break;
            case 25:
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('DiffConfigManager: Failed to load server configuration', configResponse.status, 1);
            case 26:
              _context.next = 31;
              break;
            case 28:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('DiffConfigManager: Error loading server configuration', _context.t0, 1);
            case 31:
              _context.prev = 31;
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 6:
              ...
              break;
            case 8:
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Skipping server config load - serverSaveEnabled already set', window.diffConfig.serverSaveEnabled, 2);
            case 9:
              // Then apply the provided config
              if (typeof window !== 'undefined') {
                window.diffConfig = _objectSpread(_objectSpread({}, window.diffConfig || {}), config);
              } else {
                _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('DiffConfigManager: Cannot initialize, window is not available', null, 1);
              }
            case 10:
            case "end":
    ...
    value: function getDiffConfig() {
      if (typeof window === 'undefined' || !window.diffConfig) {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('DiffConfigManager: window.diffConfig is not available', null, 1);
        return {};
      }
    ...
    value: function setDiffConfig() {
      ...
      if (typeof window !== 'undefined') {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('DiffConfigManager: Cannot set config, window is not available', null, 1);
      }
    }
    ...
    key: "setDiffConfigSafe",
    value: function setDiffConfigSafe() {
      var config = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Setting new diffConfig safely (preserving runtime values)', config, 2);
      if (typeof window === 'undefined') {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('DiffConfigManager: Cannot set config, window is not available', null, 1);
        return;
      }
      ...
      var criticalRuntimeProps = ['fileRefId', 'oldFileRefId', 'newFileName', 'oldFileName', 'serverSaveEnabled'];

      // Preserve existing critical values
      var preservedValues = {};
      criticalRuntimeProps.forEach(function (prop) {
        if (window.diffConfig && window.diffConfig[prop] !== undefined && window.diffConfig[prop] !== null && window.diffConfig[prop] !== '') {
          ...
          _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("DiffConfigManager: Preserving existing ".concat(prop), window.diffConfig[prop], 3);
        }
      });
      ...
      Object.entries(preservedValues).forEach(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
          key = _ref2[0],
          value = _ref2[1];
        window.diffConfig[key] = value;
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("DiffConfigManager: Restored critical runtime property ".concat(key), value, 3);
      });
      _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('DiffConfigManager: Safe setDiffConfig completed', {
    ...
    value: function reset() {
      ...
      if (typeof window !== 'undefined') {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('DiffConfigManager: Cannot reset config, window is not available', null, 1);
      }
    }
    ...
    value: function update() {
      ...
      if (typeof window === 'undefined' || !window.diffConfig) {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('DiffConfigManager: window.diffConfig not available for update', null, 1);
        return;
      }
    ...
    value: function set(key, value) {
      ...
      if (typeof window !== 'undefined' && window.diffConfig) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error("DiffConfigManager: Cannot set ".concat(key, ", window.diffConfig not available"), null, 1);
      }
    }
    ...
    value: function get(key) {
      var defaultValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      if (typeof window === 'undefined' || !window.diffConfig) {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn("DiffConfigManager: Cannot get ".concat(key, ", window.diffConfig not available"), null, 1);
        return defaultValue;
      }
    ...
    value: function has(key) {
      if (typeof window === 'undefined' || !window.diffConfig) {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn("DiffConfigManager: Cannot check ".concat(key, ", window.diffConfig not available"), null, 1);
        return false;
      }
    ...
    value: function remove(key) {
      if (typeof window !== 'undefined' && window.diffConfig && key in window.diffConfig) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn("DiffConfigManager: Cannot remove ".concat(key, ", not found or window.diffConfig not available"), null, 1);
      }
    }
  }], [{
    key: "getInstance",
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   t: () => (/* binding */ BaseSingleton)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   G: () => (/* binding */ MergeContentFormatter)
/* harmony export */ });
/* harmony import */ var _StringUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(594);
/* harmony import */ var _Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(979);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
var MergeContentFormatter = /*#__PURE__*/function () {
  ...
  return _createClass(MergeContentFormatter, null, [{
    ...
    function formatPreview(content) {
      ...
      if (!content) {
        _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('MergeContentFormatter: Empty content for preview formatting', null, 2);
      ...
      var escapedContent = _StringUtils__WEBPACK_IMPORTED_MODULE_1__/* .StringUtils */ .$.escapeHtml(content);
      ...
      var result = "<pre ".concat(lineNumberAttr, "><code class=\"").concat(languageClass, "\" data-original-code=\"").concat(_StringUtils__WEBPACK_IMPORTED_MODULE_1__/* .StringUtils */ .$.escapeAttribute(originalContent), "\">").concat(escapedContent, "</code></pre>");

      // Replace console.log with Debug utility
      _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('MergeContentFormatter: Preview HTML generated', {
...
/* harmony export */ });
/* unused harmony export AlertManager */
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(762);
/* harmony import */ var _BaseSingleton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(454);
/* harmony import */ var _Debug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(979);
/* harmony import */ var _TranslationManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(428);
...
var AlertManager = /*#__PURE__*/function (_BaseSingleton) {
  ...
  return _createClass(AlertManager, [{
    ...
    function initialize() {
      ...
      // Mark as initialized
      this.initialized = true;
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('AlertManager: Initialized', null, 2);
    }
    ...
    function _ensureContainer() {
      ...
      if (!container) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('AlertManager: Created alert container', null, 2);
      }
      return container;
    }
    ...
    value: function showAlert(message, type) {
      var _this = this;
      var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('AlertManager.showAlert called with type', type, 2);
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('AlertManager.showAlert message', message, 3);
      ...
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('AlertManager placement options', {
      ...
      var baseAlertClass = _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.ALERT ? _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.ALERT.toString().substring(1) :
      // Remove leading '.'
      'vdm-alert';
      ...
      if (type) {
        ...
        var typeClass = type === 'info' && _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.ALERT_INFO ? _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.ALERT_INFO.toString().substring(1) : // Remove leading '.'
      ...
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('Alert classnames', alertElement.className, 3);
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('Alert selector values', {
        selectorBase: _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.ALERT ? _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.ALERT.toString() : 'vdm-alert',
        selectorType: type ? "".concat(baseAlertClass, "--").concat(type) : 'none'
      }, 3);

      // Translate message if needed
      var finalMessage = message;
      if (mergedOptions.translate && typeof _TranslationManager__WEBPACK_IMPORTED_MODULE_2__/* .TranslationManager */ .n !== 'undefined') {
        var translationManager = _TranslationManager__WEBPACK_IMPORTED_MODULE_2__/* .TranslationManager */ .n.getInstance();
      ...
      if (mergedOptions.dismissable) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('Close button', closeButton ? 'found' : 'not found', 3);
      }
      ...
      if (mergedOptions.targetElement) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('Alert appended to container', null, 3);
      } else {
        // Fallback to body if no container and no target element
        document.body.appendChild(alertElement);
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('Alert appended to body', null, 3);
      }
      ...
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('Returning alert element', alertElement, 3);
      return alertElement;
    }
    ...
    value: function hideAlert() {
      ...
      if (alertElement !== null && alertElement !== void 0 && alertElement.parentNode) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('AlertManager: Hiding specific alert', null, 3);
      ...
      if ((_this$activeAlert = this.activeAlert) !== null && _this$activeAlert !== void 0 && _this$activeAlert.parentNode) {
        ...
        this.activeAlert = null;
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('AlertManager: Hiding active alert', null, 3);
      }
    }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $: () => (/* binding */ StringUtils)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   Y: () => (/* binding */ EndpointDiscovery)
/* harmony export */ });
/* harmony import */ var _Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(979);
/* harmony import */ var _BaseSingleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(454);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Using cached API endpoint', _classPrivateFieldGet(_apiEndpoint, this), 2);
            ...
            case 3:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Using configured API endpoint', window.diffConfig.apiEndpoint, 2);
            ...
            case 8:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Determined API endpoint from script location', scriptEndpoint, 2);
              _classPrivateFieldSet(_apiEndpoint, this, scriptEndpoint);
              return _context.abrupt("return", _classPrivateFieldGet(_apiEndpoint, this));
            case 13:
              // Fall back to endpoint-config.php discovery
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Discovering API endpoint from endpoint-config.php', null, 2);
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Fetching from', configUrl, 2);
            ...
            case 23:
              data = _context.sent;
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Endpoint discovery response', data, 2);
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Successfully discovered API endpoint', _classPrivateFieldGet(_apiEndpoint, this), 1);
              return _context.abrupt("return", _classPrivateFieldGet(_apiEndpoint, this));
            case 31:
            ...
            case 34:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Error discovering endpoint', _context.t0, 1);

              // Fall back to relative endpoint as a last resort
              _classPrivateFieldSet(_apiEndpoint, this, './api/');
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Using fallback endpoint', _classPrivateFieldGet(_apiEndpoint, this), 1);
              return _context.abrupt("return", _classPrivateFieldGet(_apiEndpoint, this));
            case 40:
            case "end":
              return _context.stop();
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 15:
              ...
              _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("EndpointDiscovery: Resolved ".concat(endpointName, " to endpoint"), baseUrl + fileName, 2);
...
function _determineEndpointFromScript() {
  try {
    ...
    _Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('EndpointDiscovery: Error determining endpoint from script', error, 2);
    return null;
  }
}
/**
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   X: () => (/* binding */ IconRegistry)
/* harmony export */ });
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _classCallCheck(a, n) { if (!(a instanceof n)) throw new TypeError("Cannot call a class as a function"); }
function _defineProperties(e, r) { for (var t = 0; t < r.length; t++) { var o = r[t]; o.enumerable = o.enumerable || !1, o.configurable = !0, "value" in o && (o.writable = !0), Object.defineProperty(e, _toPropertyKey(o.key), o); } }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   W: () => (/* binding */ ResourceLoader)
/* harmony export */ });
...
var ResourceLoader = /*#__PURE__*/function (_BaseSingleton) {
  ...
  return _createClass(ResourceLoader, [{
    ...
    value: function configure(config) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader: Configuring', {
        config: config
      }, 2);
      this.config = config;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader configured');
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader: Configuration complete', null, 2);
      return this;
    }
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('ResourceLoader: Must be configured before loading dependencies', null, 2);
              throw new Error('ResourceLoader must be configured before loading dependencies');
            case 3:
              _context2.prev = 3;
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader: Loading syntax highlighter core (NO THEME)', null, 2);
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader: highlight.js already loaded', null, 2);
              _context2.next = 15;
              break;
            case 9:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader: Loading highlight.js from CDN', null, 2);
              _context2.next = 12;
              return this.loadScript("".concat(this.CDN_BASE, "/highlight.js/").concat(this.HLJS_VERSION, "/highlight.min.js"));
            case 12:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader: Loading line numbers plugin', null, 2);
              _context2.next = 15;
            ...
            case 15:
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ResourceLoader: Syntax highlighter core loaded successfully', null, 2);
              return _context2.abrupt("return", true);
            case 19:
              _context2.prev = 19;
              _context2.t0 = _context2["catch"](3);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('ResourceLoader: Failed to load syntax highlighter core:', _context2.t0, 2);
      ...
      var _loadLanguage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(language) {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 4:
              // Load the language
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("ResourceLoader: Loading language ".concat(normalizedLang), null, 2);
              _context3.prev = 5;
              _context3.next = 8;
            ...
            case 8:
              ...
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("ResourceLoader: Language ".concat(normalizedLang, " loaded from CDN successfully"), null, 2);
              return _context3.abrupt("return", true);
            case 13:
              _context3.prev = 13;
              _context3.t0 = _context3["catch"](5);
              _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn("ResourceLoader: Failed to load language ".concat(normalizedLang, ", falling back to built-in languages"), {
                error: _context3.t0
              }, 2);
    ...
    value: function loadScript(url) {
      ...
      return this._cacheResource(url, new Promise(function (resolve, reject) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("ResourceLoader: Loading script: ".concat(url), null, 2);
        ...
        script.onerror = function () {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error("ResourceLoader: Failed to load script: ".concat(url), null, 2);
    ...
    value: function loadCSS(href) {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("ResourceLoader: Loading CSS: ".concat(href), null, 2);
      return new Promise(function (resolve, reject) {
        ...
        link.onerror = function () {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error("ResourceLoader: Failed to load CSS: ".concat(href), null, 2);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   e: () => (/* binding */ DOMUtils)
/* harmony export */ });
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(762);
/* harmony import */ var _Debug__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(979);
/* harmony import */ var _IconRegistry__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(648);
/* harmony import */ var _AlertManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(579);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _slicedToArray(r, e) { return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArrayLimit(r, l) { var t = null == r ? null : "undefined" != typeof Symbol && r[Symbol.iterator] || r["@@iterator"]; if (null != t) { var e, n, i, u, a = [], f = !0, o = !1; try { if (i = (t = t.call(r)).next, 0 === l) { if (Object(t) !== t) return; f = !1; } else for (; !(f = (e = i.call(t)).done) && (a.push(e.value), a.length !== l); f = !0); } catch (r) { o = !0, n = r; } finally { try { if (!f && null != t["return"] && (u = t["return"](), Object(u) !== u)) return; } finally { if (o) throw n; } } return a; } }
...
var DOMUtils = /*#__PURE__*/function () {
  ...
  return _createClass(DOMUtils, null, [{
    ...
    function setupButtonHandler(buttonId, handlerFn) {
      ...
      if (!button) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Button ".concat(buttonId, " not found"), null, 2);
        return null;
      }
      ...
      if (button._handlerId && button._handlerId !== instanceId) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log("DOMUtils: Cleaned up previous handler for ".concat(logName || buttonId), null, 2);
        handlerFn(newBtn);
    ...
    value: function getElement(id) {
      if (!id) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.error('DOMUtils.getElement: Empty ID provided', null, 1);
        return null;
      }
      ...
      if (!element) {
        try {
          ...
          _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.error("DOMUtils.getElement: Error with selector: ".concat(e.message), null, 1);
        }
      }
      if (!element) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.error("DOMUtils.getElement: Element with ID '".concat(id, "' not found"), null, 1);
      } else {
    ...
    value: function updateToggleButton(currentValue, elements, options) {
      ...
      if (!toggleBtn || !toggleIcon || !toggleText) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn('DOMUtils: Missing elements for toggle button update');
        return;
      }
      _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log("DOMUtils: Updating toggle button to ".concat(currentValue), null, 2);
      ...
      if (currentValue === firstOption) {
        ...
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Invalid toggle value: ".concat(currentValue));
      }
    }
    ...
    value: function showMessage(containerId, message) {
      ...
      if (!container) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Container #".concat(containerId, " not found for message"), null, 2);
        return false;
      }
      ...
      var alertManager = _AlertManager__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.getInstance();
      ...
      var iconClass = '';
      try {
        if (_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY && _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.HAS_ICON) {
          iconClass = _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.UTILITY.HAS_ICON.name();
        } else {
          // Fallback if HAS_ICON is not defined
          iconClass = 'vdm-has-icon';
          _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('DOMUtils: Using fallback icon class because Selectors.UTILITY.HAS_ICON is undefined', null, 2);
        }
      } catch (e) {
        // Fallback if any error occurs
        iconClass = 'vdm-has-icon';
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn('DOMUtils: Error getting icon class, using fallback', e, 2);
      }
    ...
    value: function toggleVisibility(elementId, visible) {
      ...
      if (!element) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Element #".concat(elementId, " not found for visibility toggle"), null, 2);
        return false;
      }
    ...
    value: function toggleClass(elementId, className) {
      ...
      var element = document.getElementById(elementId);
      if (!element) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Element #".concat(elementId, " not found for class toggle"), null, 2);
        return false;
      }
      if (add) {
    ...
    value: function createAndAppendElement(tagName, container) {
      ...
      if (!containerElement) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Container not found for createAndAppendElement", null, 2);
        return null;
      }
    ...
    value: function setContent(elementId, content) {
      var element = document.getElementById(elementId);
      if (!element) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Element #".concat(elementId, " not found for content update"), null, 2);
        return false;
      }
      element.innerHTML = content;
      return true;
    ...
    value: function getElements(selector) {
      ...
      if (!contextElement) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Context not found for selector: ".concat(selector), null, 2);
        return null;
      }
    ...
    value: function appendContent(elementId, content) {
      var element = document.getElementById(elementId);
      if (!element) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Element #".concat(elementId, " not found for content append"), null, 2);
        return false;
      }
    ...
    value: function removeElement(elementOrId) {
      ...
      if (!(element !== null && element !== void 0 && element.parentNode)) {
        _Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.warn("DOMUtils: Element not found or has no parent for removal", null, 2);
        return false;
      }
    ...
    value: function createIcon(iconName) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return _IconRegistry__WEBPACK_IMPORTED_MODULE_3__/* .IconRegistry */ .X.createIcon(iconName, options);
    }
    ...
    value: function getIconHtml(iconName) {
      var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return _IconRegistry__WEBPACK_IMPORTED_MODULE_3__/* .IconRegistry */ .X.getIcon(iconName, options);
    }
  }]);
}();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   N: () => (/* binding */ ChunkUtils)
/* harmony export */ });
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(762);
...
var ChunkUtils = /*#__PURE__*/function () {
  ...
  return _createClass(ChunkUtils, null, [{
    ...
    function clearCache() {
      ...
      _chunkIndex = null;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log('ChunkUtils: Cache cleared', null, 2);
    }
    ...
    value: function preloadChunks() {
      ...
      var allChunkElements = document.querySelectorAll("".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.DIFF.CHUNK, "[data-chunk-id]"));
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log("ChunkUtils: Preloading ".concat(allChunkElements.length, " chunk elements"), null, 2);
      ...
      var allIconMarkers = document.querySelectorAll("".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.ICONS.MARKER, "[data-line-id]"));
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log("ChunkUtils: Preloading ".concat(allIconMarkers.length, " icon markers"), null, 2);
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_1__/* .Debug */ .y.log("ChunkUtils: Preloaded ".concat(Object.keys(_chunkIndex.byId).length, " chunks in ").concat(duration.toFixed(2), "ms"), null, 2);
      return _chunkIndex;
    }
    ...
    value: function getChunkElements(chunkId) {
      ...
      var elements;
      if (side) {
        elements = Array.from(document.querySelectorAll("".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.DIFF.CHUNK, "[data-chunk-id=\"").concat(chunkId, "\"][data-side=\"").concat(side, "\"]")));
      } else {
        elements = Array.from(document.querySelectorAll("".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.DIFF.CHUNK, "[data-chunk-id=\"").concat(chunkId, "\"]")));
      }
    ...
    value: function getIconMarker(lineId) {
      ...
      var iconMarker = document.querySelector("".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_0__/* ["default"] */ .A.ICONS.MARKER, "[data-line-id=\"").concat(lineId, "\"]"));
...
//# sourceMappingURL=diff-viewer-97b62fbd.js.map