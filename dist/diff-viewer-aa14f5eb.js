"use strict";
(this["webpackChunkdiff_files"] = this["webpackChunkdiff_files"] || []).push([[485],{

/***/ 213:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   u: () => (/* binding */ ScrollSynchronizer)
/* harmony export */ });
...
var ScrollSynchronizer = /*#__PURE__*/function () {
  ...
  return _createClass(ScrollSynchronizer, [{
    ...
    value: function setupSynchronizedScrolling() {
      var _this = this;
      // Find panes
      var panes = this.diffViewer.container.querySelectorAll(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.PANE);
      if (panes.length !== 2) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("ScrollSynchronizer: Could not find both diff panes. Found: ".concat(panes.length), null, 2);
        return;
      }
      ...
      var leftContent = leftPane.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.PANE_CONTENT);
      var rightContent = rightPane.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.PANE_CONTENT);
      if (!leftContent || !rightContent) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ScrollSynchronizer: Could not find all required scrolling elements', null, 2);
        return;
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('ScrollSynchronizer: Horizontal and vertical scroll synchronization set up', null, 2);
    }
    ...
    value: function _updateScrollState(contentElement) {
      var wasScrolled = contentElement.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.STATUS.SCROLLED.name());
      var isScrolled = contentElement.scrollLeft > 0;

      // Only update if the state changed
      if (wasScrolled !== isScrolled) {
        if (isScrolled) {
          contentElement.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.STATUS.SCROLLED.name());
        } else {
          contentElement.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.STATUS.SCROLLED.name());
        }
      }
    }
  }]);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   $: () => (/* binding */ IconMarkerManager)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(979);
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(762);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var IconMarkerManager = /*#__PURE__*/function () {
  ...
  return _createClass(IconMarkerManager, [{
    ...
    value: function _setupIconColumn(pane) {
      ...
      var content = pane.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.PANE_CONTENT);
      if (!content) return;

      // Get code table wrapper to match height
      var codeTableWrapper = content.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.TABLE_WRAPPER);
      if (!codeTableWrapper) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('IconMarkerManager: Code table wrapper not found', null, 2);
        return;
      }

      // Create or get icon column
      var iconColumn = pane.querySelector(":scope > ".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.ICONS.COLUMN));
      if (!iconColumn) {
        iconColumn = document.createElement('div');
        iconColumn.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.ICONS.COLUMN.name();
        pane.appendChild(iconColumn);
      }

      // Get all cells with chunk IDs
      var chunkCells = content.querySelectorAll("".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.LINE_CONTENT, "[data-chunk-id]:not([data-chunk-id=\"\"]), ") + "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.LINE_PLACEHOLDER, "[data-chunk-id]:not([data-chunk-id=\"\"]), ") + "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.LINE_CONTENT_EMPTY, "[data-chunk-id]:not([data-chunk-id=\"\"])"));
      ...
      content.addEventListener('scroll', function () {
        ...
        if (content.scrollLeft > 0) {
          pane.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.STATUS.SCROLLED.name());
        } else {
          pane.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.STATUS.SCROLLED.name());
        }
      }, {
        passive: true
      });
    ...
    value: function _createIconMarker(cell, iconColumn) {
      ...
      var marker = iconColumn.querySelector("".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.ICONS.MARKER, "[data-line-id=\"").concat(lineId, "\"]"));

      // Create new marker only if it doesn't exist
      if (!marker) {
        marker = document.createElement('div');
        marker.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.ICONS.MARKER.name();

        // Add class for placeholder lines
        if (cell.classList.contains(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.LINE_PLACEHOLDER.name())) {
          marker.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.ICONS.MARKER_PLACEHOLDER.name());
        }
    ...
    value: function _calculateCellHeight() {
      ...
      var lineNumberCells = this.diffViewer.container.querySelectorAll(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.CODE.LINE_NUMBER);
      if (!lineNumberCells || lineNumberCells.length === 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('IconMarkerManager: No line number cells found, using default height', null, 2);
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("IconMarkerManager: Sampled heights: ".concat(heights.join(', '), ", using median: ").concat(medianHeight, "px"), null, 3);
      return medianHeight;
    }
    ...
    value: function _updateIconColumnHeights() {
      ...
      panes.forEach(function (pane) {
        var content = pane.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.PANE_CONTENT);
        var iconColumn = pane.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.ICONS.COLUMN);
        var codeTableWrapper = content === null || content === void 0 ? void 0 : content.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.TABLE_WRAPPER);
      ...
      if (Object.keys(heights).length > 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('IconMarkerManager: Updated icon column heights:', heights, 3);
      }
    }
  }]);
}();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   i: () => (/* binding */ CopyButton)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(979);
/* harmony import */ var _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(759);
/* harmony import */ var _modal_ModalManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(653);
...
var CopyButton = /*#__PURE__*/function () {
  ...
  return _createClass(CopyButton, null, [{
    ...
    function addCopyButtonsToPreview() {
      var containerId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.MODAL.PREVIEW_CONTENT_ID.name();
      ...
      var container = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__/* .DOMUtils */ .e.getElement(containerId);
      if (!container) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('CopyButton: Alternative container lookup results', {
          getElementById: !!directElement,
          querySelector: !!querySelectorElement
        }, 2);
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('CopyButton: Preview container not found', null, 2);
        return false;
      }
      ...
      if (!preElements || preElements.length === 0) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('CopyButton: No code blocks found in preview', null, 3);
        return false;
      }
      ...
      preElements.forEach(function (pre) {
        ...
        if (pre.querySelector(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.BUTTON)) {
          return;
        }

        // Create copy button
        var button = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__/* .DOMUtils */ .e.createElement('button', null, _constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.BUTTON.name(), {
          type: 'button',
          title: translationManager.get('copyCode')
        });

        // Add copy button content
        button.innerHTML = "<span class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.ICON.name(), "\"></span><span class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.TEXT.name(), "\">").concat(translationManager.get('copy'), "</span>");
        ...
        button.addEventListener('click', function (e) {
          ...
          if (codeEl.hasAttribute('data-original-code')) {
            ...
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('CopyButton: Using original code from attribute', null, 3);
          } else {
            textToCopy = codeEl.textContent || '';
            textToCopy = textToCopy.replace(/\n\n+/g, '\n');
            _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('CopyButton: Using text content from code element', null, 3);
          }
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('CopyButton: Text length: ' + textToCopy.length, null, 3);
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("CopyButton: Added copy buttons to ".concat(preElements.length, " code blocks"), null, 2);
      return true;
    }
    ...
    value: function _showProcessingState(button) {
      button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.PROCESSING.name());
      var textSpan = button.querySelector(".".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.TEXT.name()));
      if (textSpan) {
        textSpan.textContent = 'Open Copy Dialog...';
      }
      setTimeout(function () {
        button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.PROCESSING.name());
        if (textSpan) {
    ...
    value: function _showCopiedState(button) {
      button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.COPIED.name());
      var textSpan = button.querySelector(".".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.TEXT.name()));
      if (textSpan) {
        textSpan.textContent = 'Copied!';
      }
      setTimeout(function () {
        button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.COPY.COPIED.name());
        if (textSpan) {
          textSpan.textContent = 'Copy';
        }
      }, 2000);
    ...
    value: function _showManualCopyModal(text) {
      ...
      var modalManager = _modal_ModalManager__WEBPACK_IMPORTED_MODULE_2__/* .ModalManager */ .P.getInstance();
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('CopyButton: Showing manual copy modal', null, 2);
    }
    ...
    value: function _showCopyFailure(button) {
      button.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__/* .DOMUtils */ .e.getIconHtml('exclamation-triangle', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.UTILITY.MARGIN_END_2.name()
      }) + 'Copy Failed';
      button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.UTILITY.BUTTON_PRIMARY.name(), _constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.UTILITY.BUTTON_SUCCESS.name());
      button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.UTILITY.BUTTON_DANGER.name());
      setTimeout(function () {
        button.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__/* .DOMUtils */ .e.getIconHtml('copy', {
          classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.UTILITY.MARGIN_END_2.name()
        }) + 'Try Again';
        button.classList.remove(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.UTILITY.BUTTON_DANGER.name());
        button.classList.add(_constants_Selectors__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A.UTILITY.BUTTON_PRIMARY.name());
      }, 2000);
    }
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   w: () => (/* binding */ BrowserUIManager)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(979);
/* harmony import */ var _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(762);
...
var BrowserUIManager = /*#__PURE__*/function () {
  ...
  function BrowserUIManager(diffViewer) {
    ...
    this.translationManager = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_3__/* .TranslationManager */ .n.getInstance();
    ...
    _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("BrowserUIManager: Created with \"".concat(lang, "\" translations from ").concat(translationsSource), this.translationManager.getAllTranslations(), 2);
  }
  ...
  return _createClass(BrowserUIManager, [{
    ...
    value: function setDiffViewer(diffViewer) {
      if (diffViewer && diffViewer.options) {
        this.diffViewer = diffViewer;
        this.options = diffViewer.options;
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Updated DiffViewer reference', null, 3);
        return true;
      }
      return false;
    }
    ...
    value: function getTranslations() {
      ...
      if (this.translationManager && this.translationManager.isInitialized()) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Using translations from TranslationManager', this.translationManager.getAllTranslations(), 3);
      ...
      if ((_window$diffConfig2 = window.diffConfig) !== null && _window$diffConfig2 !== void 0 && _window$diffConfig2.translations && _typeof(window.diffConfig.translations) === 'object') {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Auto-initializing TranslationManager from window.diffConfig', window.diffConfig.translations, 3);
      ...
      if ((_this$options2 = this.options) !== null && _this$options2 !== void 0 && _this$options2.translations && _typeof(this.options.translations) === 'object') {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Using translations from local options', this.options.translations, 3);
        return this.options.translations;
      }
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: No translations found, using empty object', null, 3);
      return {};
    }
    ...
    value: function initialize() {
      var containerSelector = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.CONTAINER.WRAPPER;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Initializing UI components', null, 2);
      this.container = document.querySelector(containerSelector);
      if (!this.container) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('BrowserUIManager: Container element not found', null, 2);
        return false;
      }
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: UI components generated', null, 2);
      return true;
    }
    ...
    value: function generateThemeSwitcher() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Generating theme switcher', null, 3);

      // Get the ID without the # prefix for createElement
      var themeSwitcherId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.SWITCHER.name();
      var themeLoadingId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.LOADING_INDICATOR.name();
      var themeToggleId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.TOGGLE.name();
      ...
      if (themeSwitcher) {
        ...
        var diffContainer = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.CONTAINER.name());
        if (diffContainer || this.container.contains(themeSwitcher)) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Reusing existing theme switcher', themeSwitcherId, 2);
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Removing orphaned theme switcher', themeSwitcherId, 2);
      ...
      switcherWrapper.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME_SWITCHER.WRAPPER.name();

      // Get SVG icons for light/dark mode
      var sunIcon = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__/* .DOMUtils */ .e.getIconHtml('sun', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_END_2.name()
      });
      var moonIcon = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__/* .DOMUtils */ .e.getIconHtml('moon', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_START_2.name()
      });

      // Create theme switcher content with toggle
      switcherWrapper.innerHTML = "\n            <span class=\"".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME_SWITCHER.LABEL.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_END_2.name(), "\">").concat(sunIcon, "</span>\n            <label class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME_SWITCHER.CONTROL.name(), "\" for=\"").concat(themeToggleId, "\">\n                <input type=\"checkbox\" id=\"").concat(themeToggleId, "\" checked>\n                <span class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME_SWITCHER.SLIDER.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME_SWITCHER.SLIDER_ROUND.name(), "\"></span>\n            </label>\n            <span class=\"").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME_SWITCHER.LABEL.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_START_2.name(), " \">").concat(moonIcon, "</span>\n        ");
    ...
    value: function generateThemeSelector() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Generating theme selector', null, 3);

      // Get the ID without the # prefix for createElement
      var themeSelectorId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.SELECTOR.name();
      var themeSwitcherId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.SWITCHER.name();
      ...
      if (existingSelector) {
        ...
        if (themeSwitcher && themeSwitcher.contains(selectorContainer)) {
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Reusing existing theme selector', themeSelectorId, 2);
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Removing orphaned theme selector', themeSelectorId, 2);
      ...
      if (!themeSwitcherContainer) {
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn('BrowserUIManager: No theme switcher container found for theme selector', null, 2);
        return null;
      }

      // Create new theme selector container and element
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Creating new theme selector', themeSelectorId, 2);

      // Create the container using utility classes
      selectorContainer = document.createElement('div');
      selectorContainer.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME_SELECTOR.WRAPPER.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_END_3.name());

      // Create select element
      var selectElement = document.createElement('select');
      selectElement.id = themeSelectorId;
      selectElement.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.FORM_SELECT.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.FORM_SELECT.name());
      ...
      this.elements.themeSelectorContainer = selectorContainer;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Theme selector created and added to DOM', null, 2);
      return {
        container: selectorContainer,
    ...
    value: function generateDiffContainer() {
      var _this = this;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Generating diff container', null, 3);

      // Get IDs without the # prefix for createElement
      var diffContainerId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.CONTAINER.name();
      var viewerId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.DIFF.VIEWER.name();
      ...
      viewerElement.className = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_TOP_2.name();
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("BrowserUIManager: Viewer element (".concat(viewerId, ") created successfully: ").concat(!!createdViewer), null, 3);
    }
    ...
    value: function generateMergeControls() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Generating merge controls structure only', null, 3);

      // Get translations from options
      var translations = this.getTranslations();

      // Get IDs without the # prefix for createElement
      var previewButtonId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.MERGE.BUTTON_PREVIEW.name();
      var toggleButtonId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.MERGE.DESTINATION_TOGGLE.name();
      var toggleIconId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.MERGE.TOGGLE_ICON.name();
      var toggleTextId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.MERGE.TOGGLE_TEXT.name();
      var dropdownId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.MERGE.DESTINATION_DROPDOWN.name();
      var applyButtonId = _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.MERGE.BUTTON_APPLY.name();

      // Create merge controls container
      var mergeControls = document.createElement('div');
      mergeControls.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.MERGE.CONTROLS_ACTIONS.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.FLEX.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.ALIGN_ITEMS_CENTER.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.JUSTIFY_CONTENT_BETWEEN.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_Y_2.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.PADDING_2.name());

      // Create preview button section
      var previewSection = document.createElement('div');
      var previewButton = document.createElement('button');
      previewButton.id = previewButtonId;
      previewButton.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.BUTTON_INFO.name());
      previewButton.type = 'button';
      previewButton.innerHTML = "".concat(_utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__/* .DOMUtils */ .e.getIconHtml('eye', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_END_2.name()
      ...
      mergeSection.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.FLEX.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.ALIGN_ITEMS_CENTER.name());

      // Create a group for toggle button and dropdown - using input-group styling approach
      var toggleGroup = document.createElement('div');
      toggleGroup.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.FLEX.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.ALIGN_ITEMS_STRETCH.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_END_3.name());
      ...
      toggleButton.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.BUTTON_FLAT.name(), " vdm-input-group__prepend");
      toggleButton.type = 'button'; // Explicitly set type to button

      var toggleIcon = document.createElement('span');
      toggleIcon.id = toggleIconId;
      toggleIcon.innerHTML = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__/* .DOMUtils */ .e.getIconHtml('plus-circle', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_END_2.name()
      });
      ...
      dropdown.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.FORM_SELECT.name(), " vdm-input-group__append vdm-select-auto-width");
      ...
      applyButton.className = "".concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.BUTTON.name(), " ").concat(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.BUTTON_PRIMARY.name(), " vdm-nowrap");
      applyButton.type = 'button';
      applyButton.innerHTML = (translations.applyMerge || 'Apply Merge') + " ".concat(_utils_DOMUtils__WEBPACK_IMPORTED_MODULE_2__/* .DOMUtils */ .e.getIconHtml('file-circle-plus', {
        classes: _constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.UTILITY.MARGIN_START_2.name()
      }));
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Created empty merge controls structure (options will be populated by MergeUIController)', null, 2);
    }
    ...
    value: function showThemeLoading() {
      ...
      if (loadingContainer && themeSwitcher) {
        ...
        var message = _utils_TranslationManager__WEBPACK_IMPORTED_MODULE_3__/* .TranslationManager */ .n.getInstance().get('loadingTheme', 'Loading theme...');
    ...
    value: function destroy() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Destroying UI components', null, 2);
      ...
      var existingThemeSwitcher = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.SWITCHER.name());
      var existingThemeSelector = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.SELECTOR.name());
      ...
      this.diffViewer = null;
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: UI components destroyed', null, 2);
    }
    ...
    value: function hideThemeElements() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Hiding theme elements for identical content', null, 2);
      if (this.elements.themeSwitcher) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Hidden theme switcher', this.elements.themeSwitcher.id, 2);
      }

      // Also hide any standalone theme selector
      var themeSelector = document.getElementById(_constants_Selectors__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.THEME.SELECTOR.name());
      if (themeSelector) {
        themeSelector.style.display = 'none';
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Hidden standalone theme selector', themeSelector.id, 2);
      }
    }
    ...
    value: function showThemeElements() {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Showing theme elements for diff content', null, 2);
      if (this.elements.themeSwitcher) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Shown theme switcher', this.elements.themeSwitcher.id, 2);
      }
      ...
      if (themeSelector) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('BrowserUIManager: Shown standalone theme selector', themeSelector.id, 2);
      }
    }
  }]);
}();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ LayoutManager)
/* harmony export */ });
/* harmony import */ var _utils_Debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(979);
/* harmony import */ var _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(759);
...
var LayoutManager = /*#__PURE__*/function () {
  ...
  return _createClass(LayoutManager, [{
    ...
    value: function initialize() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('LayoutManager: Initialized', null, 2);
    }
    ...
    value: function updatePaneWidth() {
      ...
      var panes = _utils_DOMUtils__WEBPACK_IMPORTED_MODULE_1__/* .DOMUtils */ .e.getElements(_constants_Selectors__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A.DIFF.PANE, this.diffViewer.container);
      ...
      if (newWidth !== this.paneWidth) {
        ...
        _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log("LayoutManager: Updated pane width: ".concat(this.paneWidth, "px"), null, 3);
      }
    }
    ...
    value: function setupWidthObserver() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('LayoutManager: Width observer setup complete', null, 2);
    }
    ...
    value: function destroy() {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('LayoutManager: Destroyed', null, 2);
    }
  }]);
}();
...
//# sourceMappingURL=diff-viewer-aa14f5eb.js.map