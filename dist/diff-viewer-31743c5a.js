"use strict";
(this["webpackChunkdiff_files"] = this["webpackChunkdiff_files"] || []).push([[479],{
    ...
    if (prop === 'name') {
      return function () {
        if (target.startsWith('#') || target.startsWith('.')) {
          ...
          _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.warn("Selector '".concat(target, "' doesn't start with '.' or '#' but name() was called on it"));
          return target;
        }
      };
    }
...
var getUtilitySelectors = function getUtilitySelectors() {
  ...
  if (window.diffConfig && window.diffConfig.ui) {
    try {
      ...
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.log('Overriding UI selectors with config values', window.diffConfig.ui, 2);
    } catch (e) {
      _utils_Debug__WEBPACK_IMPORTED_MODULE_0__/* .Debug */ .y.error('Error applying UI selector overrides from config', e, 1);
    }
  }
...
//# sourceMappingURL=diff-viewer-31743c5a.js.map